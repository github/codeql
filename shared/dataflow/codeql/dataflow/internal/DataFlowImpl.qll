...
module MakeImpl<LocationSig Location, InputSig<Location> Lang> {
  ...
  module Impl<FullStateConfigSig Config, Stage1Output<Config::FlowState> Stage1> {
    ...
    private module MkStage<StageSig PrevStage> {
      ...
      module Stage<StageParam Param> implements StageSig {
        ...
        additional module Debug {
          ...
          predicate maxFanOut(PathNodeImpl pred, PathNodeImpl succ) {
            fanOut(pred) = max(fanOut(_)) and
            succ = pred.getASuccessorImpl(_)
          }

          predicate maxFanIn(PathNodeImpl pred, PathNodeImpl succ) {
            fanIn(succ) = max(fanIn(_)) and
            succ = pred.getASuccessorImpl(_)
          }
          ...
          predicate maxPathNodes(
            ...
            pathNodes(node) = max(pathNodes(_))
          }
        }
        /* End: Stage logic. */
      }
    ...
    module Debug {
      ...
      predicate stage2maxFanOut = Stage2::Debug::maxFanOut/2;

      predicate stage2maxFanIn = Stage2::Debug::maxFanIn/2;

      predicate stage2maxPathNodes = Stage2::Debug::maxPathNodes/6;
      ...
      predicate stage3maxFanOut = Stage3::Debug::maxFanOut/2;

      predicate stage3maxFanIn = Stage3::Debug::maxFanIn/2;

      predicate stage3maxPathNodes = Stage3::Debug::maxPathNodes/6;
      ...
      predicate stage4maxFanOut = Stage4::Debug::maxFanOut/2;

      predicate stage4maxFanIn = Stage4::Debug::maxFanIn/2;

      predicate stage4maxPathNodes = Stage4::Debug::maxPathNodes/6;
      ...
      predicate stage5maxFanOut = Stage5::Debug::maxFanOut/2;

      predicate stage5maxFanIn = Stage5::Debug::maxFanIn/2;

      predicate stage5maxPathNodes = Stage5::Debug::maxPathNodes/6;
      ...
      predicate stage6maxFanOut = Stage6::Debug::maxFanOut/2;

      predicate stage6maxFanIn = Stage6::Debug::maxFanIn/2;

      predicate stage6maxPathNodes = Stage6::Debug::maxPathNodes/6;
    }
  }
}
