...
public class VariableDeclarator extends Expression {
	 ...
	 *
	 * Currently only {@link DeclarationFlags#definiteAssignmentAssertion} may be set on
	 * variable declarators.
	 */
	private final int flags;

	public VariableDeclarator(SourceLocation loc, IPattern id, Expression init, ITypeExpression typeAnnotation, int flags) {
	...
	/**
	 * Returns the modifiers set on this variable, as defined by
	 * {@link DeclarationFlags}.
	 */
	public int getFlags() {
		return this.flags;
	}
