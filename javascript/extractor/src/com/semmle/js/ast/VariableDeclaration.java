...
public class VariableDeclaration extends Statement {
	...
	public VariableDeclaration(SourceLocation loc, String kind, List<VariableDeclarator> declarations, boolean hasDeclareKeyword) {
	...
	/**
	 * The kind of this variable declaration statement; one of <code>"var"</code>,
	 ...
	 *
	 * Note that <code>const</code> declarations are function-scoped pre-ECMAScript 2015.
	 */
	public boolean isBlockScoped(ECMAVersion ecmaVersion) {
		return "let".equals(kind) || ecmaVersion.compareTo(ECMAVersion.ECMA2015) >= 0 && "const".equals(kind);
	}
