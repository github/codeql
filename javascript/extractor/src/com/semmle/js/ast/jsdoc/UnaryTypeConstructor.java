...
public abstract class UnaryTypeConstructor extends JSDocTypeExpression {
	...
	public UnaryTypeConstructor(SourceLocation loc, String type, JSDocTypeExpression expression, Boolean prefix, String operator) {
		super(loc, type);
	...
	public String pp() {
		...
		if (prefix)
			return operator + expression.pp();
		else
			return expression.pp() + operator;
	}
