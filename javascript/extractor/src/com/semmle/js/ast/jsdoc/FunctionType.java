...
public class FunctionType extends JSDocTypeExpression {
	...
	public FunctionType(SourceLocation loc, JSDocTypeExpression _this, Boolean _new, List<JSDocTypeExpression> params,
	...
	/**
	 * Does this function type expression specify a receiver type, that is, a type for <code>this</code>?
	 */
