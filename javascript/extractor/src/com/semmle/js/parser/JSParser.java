...
public class JSParser {
	 ...
	 *
	 * If the parse was successful, {@link #ast} will be non-null.
	 * Otherwise, {@link #errors} holds a list of parse errors encountered.
	 */
	public static class Result {
		...
		public Result(String source, Node ast, List<Token> tokens, List<Comment> comments, List<ParseError> errors) {
			this.source = source;
			this.ast = ast;
			this.tokens = tokens;
