...
/**
 * This class handles location information; in particular, it translates
 * locations reported by the various parsers to absolute source file locations.
 */
public class LocationManager {
	...
	/** Emit an entry in the {@code locations_default} table. No line or column adjustment is performed. */
	...
	/** Emit location information for a parse error. These locations are special, since
	 * their reported line number can be one past the last line in the file. Our toolchain does not like
	 * such positions, so we artificially constrain the line number to be in an acceptable range. */
