...
public class NodeJSDetectorTests {
	...
	public void testComment() {
		isNodeJS("/** My awesome package.\n"
			+ "* (C) me.\n"
			+ "*/\n"
			+ "\n"
			+ "var isArray = require(\"isArray\");", true);
	}
	...
	public void amdefine() {
		...
		isNodeJS("if (typeof define !== 'function') define = require('amdefine')(module, require);", false);
	}
