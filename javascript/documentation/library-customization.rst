...
the standard library defines an abstract class ``CommandExecution::Range`` that covers various APIs
...
of a system command to execute. By defining additional subclasses of ``CommandExecution::Range``, we
