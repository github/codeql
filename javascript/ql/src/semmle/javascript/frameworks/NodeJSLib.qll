...
module NodeJSLib {
   ...
   */
  abstract class ResponseExpr extends https::Servers::StandardResponseExpr { }
   ...
   * object should implement a library specific subclass of this class.
   */
  abstract class RequestExpr extends https::Servers::StandardRequestExpr { }
   ...
   */
  abstract class RouteHandler extends https::Servers::StandardRouteHandler, DataFlow::FunctionNode {
    /**
  ...
  class RouteSetup extends CallExpr, https::Servers::StandardRouteSetup {
    ...
    private DataFlow::SourceNode getARouteHandler(DataFlow::TypeBackTracker t) {
      ...
      exists(DataFlow::TypeBackTracker t2, DataFlow::SourceNode succ | succ = getARouteHandler(t2) |
        ...
        or
        t = t2 and
        https::routeHandlerStep(result, succ)
      )
    }
  ...
  abstract private class HeaderDefinition extends https::Servers::StandardHeaderDefinition {
    ...
    override https::RouteHandler getRouteHandler() { result = r.getRouteHandler() }
  }
   ...
   */
  class ServerDefinition extends https::Servers::StandardServerDefinition {
  ...
  private class NodeHttpUrlRequest extends NodeJSClientRequest::Range, NodeJSEventEmitter {
    ...
    NodeHttpUrlRequest() {
      exists(string moduleName, DataFlow::SourceNode callee | this = callee.getACall() |
        ...
        (
          callee = DataFlow::moduleMember(moduleName, any(https::RequestMethodName m).toLowerCase())
          or
