...
module Firebase {
  ...
  module CloudFunctions {
     ...
     */
    private class RouteSetup extends https::Servers::StandardRouteSetup, CallExpr {
      RouteSetup() {
     ...
     */
    private class RouteHandler extends Express::RouteHandler, https::Servers::StandardRouteHandler,
      DataFlow::ValueNode {
