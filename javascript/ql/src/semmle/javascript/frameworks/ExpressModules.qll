...
module ExpressLibraries {
   ...
   */
  class XFrameOptionsRouteHandlerHeader extends https::ImplicitHeaderDefinition {
    ...
    override https::RouteHandler getRouteHandler() { result = this }
  }

  /**
   * Route handler from the "x-frame-options" module.
   */
  class XFrameOptionsRouteHandler extends https::RouteHandler {
   ...
   */
  class FrameGuardRouteHandlerHeader extends https::ImplicitHeaderDefinition {
   ...
   */
  class FrameGuardRouteHandler extends https::RouteHandler {
   ...
   */
  class HelmetRouteHandlerHeader extends https::ImplicitHeaderDefinition {
   ...
   */
  class HelmetRouteHandler extends https::RouteHandler {
    HelmetRouteHandler() {
  ...
  module ExpressSession {
     ...
     */
    class MiddlewareInstance extends DataFlow::InvokeNode, https::CookieMiddlewareInstance {
