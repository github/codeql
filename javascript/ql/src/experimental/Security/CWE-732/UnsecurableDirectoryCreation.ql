  ...
  UnsecurableDirectoryCreation() {
    this =
      [
        ...
        DataFlow::moduleMember("fs-extra-p", "createLink"),
        DataFlow::moduleMember("fs-extra-p", "createLinkSync"),
        DataFlow::moduleMember("fs-extra-p", "createSymlink"),
        DataFlow::moduleMember("fs-extra-p", "createSymlinkSync"),
        DataFlow::moduleMember("fs-extra-p", "emptyDir"),
        DataFlow::moduleMember("fs-extra-p", "emptyDirSync"),
        DataFlow::moduleMember("fs-extra-p", "emptydir"),
        DataFlow::moduleMember("fs-extra-p", "emptydirSync"),
        DataFlow::moduleMember("fs-extra-p", "ensureFile"),
        DataFlow::moduleMember("fs-extra-p", "ensureFileSync"),
        DataFlow::moduleMember("fs-extra-p", "ensureLink"),
        DataFlow::moduleMember("fs-extra-p", "ensureLinkSync"),
        DataFlow::moduleMember("fs-extra-p", "ensureSymlink"),
        DataFlow::moduleMember("fs-extra-p", "ensureSymlinkSync"),
        DataFlow::moduleMember("fs-extra-p", "outputFile"),
        DataFlow::moduleMember("fs-extra-p", "outputFileSync"),
