...
private module StandardPoIs {
  ...
  class UnpromotedRouteSetupPoI extends PoI {
    ...
    override predicate is(Node l0) {
      l0 instanceof https::RouteSetupCandidate and not l0.asExpr() instanceof https::RouteSetup
    }
  }
  ...
  class UnpromotedRouteHandlerPoI extends PoI {
    ...
    override predicate is(Node l0) {
      l0 instanceof https::RouteHandlerCandidate and not l0 instanceof https::RouteHandler
    }
  }
  ...
  class UnpromotedRouteHandlerWithFlowPoI extends PoI {
    ...
    private DataFlow::SourceNode track(https::RouteHandlerCandidate cand, DataFlow::TypeTracker t) {
      t.start() and
      result = cand
      or
    ...
    override predicate is(Node l0, Node l1, string t1) {
      l0 instanceof https::RouteHandlerCandidate and
      not l0 instanceof https::RouteHandler and
