...
/^[\.\w&#230;&#248;&#229;-]+@([a-z&#230;&#248;&#229;0-9]+([\.-]{0,1}[a-z&#230;&#248;&#229;0-9]+|[a-z&#230;&#248;&#229;0-9]?))+\.[a-z]{2,6}$/g; // $ TODO-SPURIOUS: Alert[js/redos]
/"((\\")|[^"(\\")])+"/g;
/<[^>]+>/g;
...
/(\S*)+(\u007C)+(\S*)/g; // $ TODO-SPURIOUS: Alert[js/redos]
/([^\.\?\!]*)[\.\?\!]/g;
/(\S+)\x20{2,}(?=\S+)/g;
/^([6011]{4})([0-9]{12})$/g;
/^([30|36|38]{2})([0-9]{12})$/g;
/^(?!000)(?!666)(?<SSN3>[0-6]\d{2}|7(?:[0-6]\d|7[012]))([- ]?)(?!00)(?<SSN2>\d\d)\1(?!0000)(?<SSN4>\d{4})$/g;
/^([a-z0-9]+([\-a-z0-9]*[a-z0-9]+)?\.){0,}([a-z0-9]+([\-a-z0-9]*[a-z0-9]+)?){1,63}(\.[a-z0-9]{2,7})+$/g; // $ TODO-SPURIOUS: Alert[js/redos]
