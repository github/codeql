...
app.post('/upload', async (req, res) => {
    ...
    // Unsafe
    RemoteStream.pipe(unzipper.Extract({ path: 'output/path' })); // $ TODO-SPURIOUS: Alert

    // Unsafe
    RemoteStream.pipe(unzipper.ParseOne()) // $ TODO-SPURIOUS: Alert
        .pipe(createWriteStream('firstFile.txt'));

    // Safe because of uncompressedSize
    RemoteStream
        .pipe(unzipper.Parse()) // $ TODO-SPURIOUS: Alert
    ...
    // Unsafe
    const zip = RemoteStream.pipe(unzipper.Parse({ forceStream: true })); // $ TODO-SPURIOUS: Alert
    ...
    // Safe
    const zip2 = RemoteStream.pipe(unzipper.Parse({ forceStream: true })); // $ TODO-SPURIOUS: Alert
    ...
    // Safe  because of uncompressedSize
    RemoteStream.pipe(unzipper.Parse()) // $ TODO-SPURIOUS: Alert
