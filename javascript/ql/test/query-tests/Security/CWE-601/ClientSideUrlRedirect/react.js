    ...
    return (
        <div className="application">
            <Helmet>
                ...
                <script type="application/javascript" src={document.location.hash.substr(1)}/> {/* NOT OK */} // $ TODO-SPURIOUS: Alert
            </Helmet>
        </div>
    );
  }
...
export function NextLink() {
    return <>
      ...
      <Link href={document.location.hash.substr(1)}><a>unsafe</a></Link> {/* NOT OK */} // $ TODO-SPURIOUS: Alert
    </>;
}
