...
app.post('/doSomethingTerrible', (req, res) => { // $ RelatedLocation // uses cookies
...
app.post('/user', (req, res) => { // $ RelatedLocation // access to req.user is unprotected
    somethingElse(req.user.name);
    res.end('Ok');
});

app.post('/session', (req, res) => { // $ RelatedLocation // access to req.session is unprotected
