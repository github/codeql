...
(function(){
    ...
    var views_local = (req, res) => res.render(req.params[0]); // $ TODO-SPURIOUS: Alert
...
var server = http.createServer(function(req, res) {
	...
	res.write(fs.readFileSync(fs.realpathSync(path))); // $ TODO-SPURIOUS: Alert
	fs.realpath(path,
	                function(err, realpath){
		                res.write(fs.readFileSync(realpath)); // $ TODO-SPURIOUS: Alert
	                }
	               );
