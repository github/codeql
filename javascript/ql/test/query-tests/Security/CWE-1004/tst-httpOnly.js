...
app.use(session({
    name: 'session',
    keys: ['key1', 'key2'],
    httpOnly: false // $ TODO-MISSING: Alert
})) // $ TODO-SPURIOUS: Alert
...
app.use(session({
    name: 'session',
    keys: ['key1', 'key2'],
    httpOnly: flag2 // $ TODO-MISSING: Alert
})) // $ TODO-SPURIOUS: Alert
...
app.get('/a', function (req, res, next) {
    ...
    res.cookie('authkey', 'value', options); // $ TODO-SPURIOUS: Alert
    res.end('ok')
})
...
app.use(session({
    name: 'session',
    keys: ['key1', 'key2'],
    cookie: { httpOnly: false } // $ TODO-MISSING: Alert
})) // $ TODO-SPURIOUS: Alert
...
app.use(session({
    name: 'mycookie',
    keys: ['key1', 'key2'],
    cookie: { httpOnly: false } // $ TODO-MISSING: Alert - It is a session cookie, name doesn't matter
})) // $ TODO-SPURIOUS: Alert
