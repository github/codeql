...
function f18() {
    var secret = (o.password = Math.random()); // $ TODO-SPURIOUS: Alert
}

(function(){
    var crypto = require('crypto');
    crypto.createHmac('sha256', Math.random()); // $ TODO-SPURIOUS: Alert
})();
...
function uid() {
    ...
    var MY_UID = Math.random(); // $ TODO-SPURIOUS: Alert - NOK OK
}
