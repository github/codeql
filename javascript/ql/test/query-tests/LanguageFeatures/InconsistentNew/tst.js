...
class C {}
new C();
C(); // $ TODO-MISSING: Alert - but flagged by IllegalInvocation
...
new Point(42, 23); // $ TODO-MISSING: Alert - but not flagged since line 6 above was already flagged
Point(56, 72);     // $ TODO-MISSING: Alert - but not flagged since line 7 above was already flagged
