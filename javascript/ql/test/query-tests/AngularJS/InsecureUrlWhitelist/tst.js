angular.module('myApp', [])
    .config(function($sceDelegateProvider) {
        $sceDelegateProvider.resourceUrlWhitelist([
            "**://example.com/*", // BAD (exploit: https://evil.com/?ignore=://example.org/a or javascript:alert(1);://example.org/a)
            ...
            "https://example.**", // BAD (exploit: https://example.evil.com or https://example.:foo@evil.com)
            ...
            // not flagged:
            /https:\/\/www.example.org/g // BAD (exploit https://wwwaexample.org (dots are not escaped))
        ]);
    });
