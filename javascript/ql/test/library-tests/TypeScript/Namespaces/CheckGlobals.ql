...
where expectedKind = getStringKind(variable.getAnAssignedExpr())
	and actualKind = getVariableKind(variable)
	and expectedKind != actualKind
select variable, variable.getName() + " resolves as a " + actualKind + ", but it should be " + expectedKind
