...
private class SystemCommandExecutors extends CommandExecution::Range, DataFlow::InvokeNode {
  int cmdArg;
...
private class RemoteCommandExecutor extends CommandExecution::Range, DataFlow::InvokeNode {
  int cmdArg;
...
private class Opener extends CommandExecution::Range, DataFlow::InvokeNode {
