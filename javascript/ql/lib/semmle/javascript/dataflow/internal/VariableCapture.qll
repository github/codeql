...
module VariableCaptureConfig implements InputSig<js::DbLocation, js::Cfg::BasicBlock> {
...
module VariableCaptureOutput = Flow<js::DbLocation, js::Cfg, VariableCaptureConfig>;
