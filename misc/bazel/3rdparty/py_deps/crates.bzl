...
_CRATE_EDITIONS = {
    "python/extractor/tsg-python": "2024",
    "python/extractor/tsg-python/tsp": "2024",
}
...
def crate_repositories():
    ...
    maybe(
        ...
        crates_module = Label("//misc/bazel/3rdparty/py_deps:crates.bzl"),
    )
    maybe(
        http_archive,
    ...
    return [
        struct(repo = "vendor_py", is_dev_dep = False),
