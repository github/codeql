...
_NORMAL_DEPENDENCIES = {
    "ruby/extractor": {
        _COMMON_CONDITION: {
            "clap": Label("@vendor__clap-4.5.24//:clap"),
    ...
    "rust/ast-generator": {
        _COMMON_CONDITION: {
            ...
            "stdx": Label("@vendor__ra_ap_stdx-0.0.256//:ra_ap_stdx"),
    ...
    "rust/extractor": {
        _COMMON_CONDITION: {
            ...
            "ra_ap_base_db": Label("@vendor__ra_ap_base_db-0.0.256//:ra_ap_base_db"),
            "ra_ap_cfg": Label("@vendor__ra_ap_cfg-0.0.256//:ra_ap_cfg"),
            "ra_ap_hir": Label("@vendor__ra_ap_hir-0.0.256//:ra_ap_hir"),
            "ra_ap_hir_def": Label("@vendor__ra_ap_hir_def-0.0.256//:ra_ap_hir_def"),
            "ra_ap_hir_expand": Label("@vendor__ra_ap_hir_expand-0.0.256//:ra_ap_hir_expand"),
            "ra_ap_ide_db": Label("@vendor__ra_ap_ide_db-0.0.256//:ra_ap_ide_db"),
            "ra_ap_intern": Label("@vendor__ra_ap_intern-0.0.256//:ra_ap_intern"),
            "ra_ap_load-cargo": Label("@vendor__ra_ap_load-cargo-0.0.256//:ra_ap_load_cargo"),
            "ra_ap_parser": Label("@vendor__ra_ap_parser-0.0.256//:ra_ap_parser"),
            "ra_ap_paths": Label("@vendor__ra_ap_paths-0.0.256//:ra_ap_paths"),
            "ra_ap_project_model": Label("@vendor__ra_ap_project_model-0.0.256//:ra_ap_project_model"),
            "ra_ap_span": Label("@vendor__ra_ap_span-0.0.256//:ra_ap_span"),
            "ra_ap_syntax": Label("@vendor__ra_ap_syntax-0.0.256//:ra_ap_syntax"),
            "ra_ap_vfs": Label("@vendor__ra_ap_vfs-0.0.256//:ra_ap_vfs"),
    ...
    "rust/extractor/macros": {
        _COMMON_CONDITION: {
            "quote": Label("@vendor__quote-1.0.38//:quote"),
            "syn": Label("@vendor__syn-2.0.95//:syn"),
        },
    },
...
_NORMAL_ALIASES = {
    ...
    "rust/ast-generator": {
        _COMMON_CONDITION: {
            "@vendor__ra_ap_stdx-0.0.256//:ra_ap_stdx": "stdx",
        },
    },
    "rust/autobuild": {
    },
...
def crate_repositories():
    ...
    maybe(
        http_archive,
        name = "vendor__clap-4.5.24",
        sha256 = "9560b07a799281c7e0958b9296854d6fafd4c5f31444a7e5bb1ad6dde5ccf1bd",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/clap/4.5.24/download"],
        strip_prefix = "clap-4.5.24",
        build_file = Label("//misc/bazel/3rdparty/tree_sitter_extractors_deps:BUILD.clap-4.5.24.bazel"),
    )

    maybe(
        http_archive,
        name = "vendor__clap_builder-4.5.24",
        sha256 = "874e0dd3eb68bf99058751ac9712f622e61e6f393a94f7128fa26e3f02f5c7cd",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/clap_builder/4.5.24/download"],
        strip_prefix = "clap_builder-4.5.24",
        build_file = Label("//misc/bazel/3rdparty/tree_sitter_extractors_deps:BUILD.clap_builder-4.5.24.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//misc/bazel/3rdparty/tree_sitter_extractors_deps:BUILD.proc-macro2-1.0.92.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "vendor__ra_ap_base_db-0.0.256",
        sha256 = "99c6bdbbb62ae431e995af9a1500becc04640c69f1407fb357fd1d13d6872864",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/ra_ap_base_db/0.0.256/download"],
        strip_prefix = "ra_ap_base_db-0.0.256",
        build_file = Label("//misc/bazel/3rdparty/tree_sitter_extractors_deps:BUILD.ra_ap_base_db-0.0.256.bazel"),
    )

    maybe(
        http_archive,
        name = "vendor__ra_ap_cfg-0.0.256",
        sha256 = "6a266aa3553bae0a4b2853f0719fa525baac566f021252a83e3b0c82b219d257",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/ra_ap_cfg/0.0.256/download"],
        strip_prefix = "ra_ap_cfg-0.0.256",
        build_file = Label("//misc/bazel/3rdparty/tree_sitter_extractors_deps:BUILD.ra_ap_cfg-0.0.256.bazel"),
    )

    maybe(
        http_archive,
        name = "vendor__ra_ap_edition-0.0.256",
        sha256 = "8ec96d33a7c8d28658da8f347d4141d8edb4a966f5cbe4216ae590682d9e80f7",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/ra_ap_edition/0.0.256/download"],
        strip_prefix = "ra_ap_edition-0.0.256",
        build_file = Label("//misc/bazel/3rdparty/tree_sitter_extractors_deps:BUILD.ra_ap_edition-0.0.256.bazel"),
    )

    maybe(
        http_archive,
        name = "vendor__ra_ap_hir-0.0.256",
        sha256 = "21df07c5b3b1f84d0507cbd86fdde9e697b96902bbb0944159c7cae64a9e453e",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/ra_ap_hir/0.0.256/download"],
        strip_prefix = "ra_ap_hir-0.0.256",
        build_file = Label("//misc/bazel/3rdparty/tree_sitter_extractors_deps:BUILD.ra_ap_hir-0.0.256.bazel"),
    )

    maybe(
        http_archive,
        name = "vendor__ra_ap_hir_def-0.0.256",
        sha256 = "533dbff99d632dfbfc20c8435f6f30ced37f77c51eff052b98d9a0676118a6f9",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/ra_ap_hir_def/0.0.256/download"],
        strip_prefix = "ra_ap_hir_def-0.0.256",
        build_file = Label("//misc/bazel/3rdparty/tree_sitter_extractors_deps:BUILD.ra_ap_hir_def-0.0.256.bazel"),
    )

    maybe(
        http_archive,
        name = "vendor__ra_ap_hir_expand-0.0.256",
        sha256 = "7f5a00d6f41404e103abac282dc0869fb7eed79dd6f51bdb9884c2777fe1be9b",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/ra_ap_hir_expand/0.0.256/download"],
        strip_prefix = "ra_ap_hir_expand-0.0.256",
        build_file = Label("//misc/bazel/3rdparty/tree_sitter_extractors_deps:BUILD.ra_ap_hir_expand-0.0.256.bazel"),
    )

    maybe(
        http_archive,
        name = "vendor__ra_ap_hir_ty-0.0.256",
        sha256 = "8b656d7b474fe1df2927048f9250930fe98c9fa3292736533439c530ab3dc540",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/ra_ap_hir_ty/0.0.256/download"],
        strip_prefix = "ra_ap_hir_ty-0.0.256",
        build_file = Label("//misc/bazel/3rdparty/tree_sitter_extractors_deps:BUILD.ra_ap_hir_ty-0.0.256.bazel"),
    )

    maybe(
        http_archive,
        name = "vendor__ra_ap_ide_db-0.0.256",
        sha256 = "ef4dee9186d381879583e52f56334aec782a3b1aefb6c76882ffa234ffed1686",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/ra_ap_ide_db/0.0.256/download"],
        strip_prefix = "ra_ap_ide_db-0.0.256",
        build_file = Label("//misc/bazel/3rdparty/tree_sitter_extractors_deps:BUILD.ra_ap_ide_db-0.0.256.bazel"),
    )

    maybe(
        http_archive,
        name = "vendor__ra_ap_intern-0.0.256",
        sha256 = "c987d23dcb94c930ab8d899afc824ca1742d6e741bb46c69fd91a9264db23475",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/ra_ap_intern/0.0.256/download"],
        strip_prefix = "ra_ap_intern-0.0.256",
        build_file = Label("//misc/bazel/3rdparty/tree_sitter_extractors_deps:BUILD.ra_ap_intern-0.0.256.bazel"),
    )

    maybe(
        http_archive,
        name = "vendor__ra_ap_limit-0.0.256",
        sha256 = "a5284aa7a61106d6cfd803119f30a00be3a5bc50ca6518d4d4837a35a7c7e9fd",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/ra_ap_limit/0.0.256/download"],
        strip_prefix = "ra_ap_limit-0.0.256",
        build_file = Label("//misc/bazel/3rdparty/tree_sitter_extractors_deps:BUILD.ra_ap_limit-0.0.256.bazel"),
    )

    maybe(
        http_archive,
        name = "vendor__ra_ap_load-cargo-0.0.256",
        sha256 = "d3b53708983a8d9f09559e8de518cbe5a11b2d6442410d7724c95d815b0c0194",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/ra_ap_load-cargo/0.0.256/download"],
        strip_prefix = "ra_ap_load-cargo-0.0.256",
        build_file = Label("//misc/bazel/3rdparty/tree_sitter_extractors_deps:BUILD.ra_ap_load-cargo-0.0.256.bazel"),
    )

    maybe(
        http_archive,
        name = "vendor__ra_ap_mbe-0.0.256",
        sha256 = "912099d336088efd7c3ab4068413a9b82959b5d5ca9e8ee1a64142909d005e7c",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/ra_ap_mbe/0.0.256/download"],
        strip_prefix = "ra_ap_mbe-0.0.256",
        build_file = Label("//misc/bazel/3rdparty/tree_sitter_extractors_deps:BUILD.ra_ap_mbe-0.0.256.bazel"),
    )

    maybe(
        http_archive,
        name = "vendor__ra_ap_parser-0.0.256",
        sha256 = "80ab65fabcc88bb30f6318bd81ec1099f7e3d68ee415bbc6a6c2acea6d564b19",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/ra_ap_parser/0.0.256/download"],
        strip_prefix = "ra_ap_parser-0.0.256",
        build_file = Label("//misc/bazel/3rdparty/tree_sitter_extractors_deps:BUILD.ra_ap_parser-0.0.256.bazel"),
    )

    maybe(
        http_archive,
        name = "vendor__ra_ap_paths-0.0.256",
        sha256 = "a25a2069ae1ce1ff17c5181ebd082db46a78f7dd8af1627c38f1952db54a45b7",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/ra_ap_paths/0.0.256/download"],
        strip_prefix = "ra_ap_paths-0.0.256",
        build_file = Label("//misc/bazel/3rdparty/tree_sitter_extractors_deps:BUILD.ra_ap_paths-0.0.256.bazel"),
    )

    maybe(
        http_archive,
        name = "vendor__ra_ap_proc_macro_api-0.0.256",
        sha256 = "ea96c5e434a6e8939c76c457e26c20314c4d5bef438532287b447693c1fa7557",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/ra_ap_proc_macro_api/0.0.256/download"],
        strip_prefix = "ra_ap_proc_macro_api-0.0.256",
        build_file = Label("//misc/bazel/3rdparty/tree_sitter_extractors_deps:BUILD.ra_ap_proc_macro_api-0.0.256.bazel"),
    )

    maybe(
        http_archive,
        name = "vendor__ra_ap_profile-0.0.256",
        sha256 = "0a0e88b2eb891da451f538e3ecda63ece317a2c84fd7091d6f0019e8a3af4d64",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/ra_ap_profile/0.0.256/download"],
        strip_prefix = "ra_ap_profile-0.0.256",
        build_file = Label("//misc/bazel/3rdparty/tree_sitter_extractors_deps:BUILD.ra_ap_profile-0.0.256.bazel"),
    )

    maybe(
        http_archive,
        name = "vendor__ra_ap_project_model-0.0.256",
        sha256 = "1e30e52df4c6602c52568344d65229f5300d7f8d1085f90acf588e52c72a3ae2",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/ra_ap_project_model/0.0.256/download"],
        strip_prefix = "ra_ap_project_model-0.0.256",
        build_file = Label("//misc/bazel/3rdparty/tree_sitter_extractors_deps:BUILD.ra_ap_project_model-0.0.256.bazel"),
    )

    maybe(
        http_archive,
        name = "vendor__ra_ap_salsa-0.0.256",
        sha256 = "9ef6892f88551a662b9ceeb459692be97d5f1ec06f9683967399bcc8105220f5",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/ra_ap_salsa/0.0.256/download"],
        strip_prefix = "ra_ap_salsa-0.0.256",
        build_file = Label("//misc/bazel/3rdparty/tree_sitter_extractors_deps:BUILD.ra_ap_salsa-0.0.256.bazel"),
    )

    maybe(
        http_archive,
        name = "vendor__ra_ap_salsa-macros-0.0.256",
        sha256 = "b52847f205683c8ccbcd8535cbb73ca60df7818263043c81779a2d0d97d1d1ed",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/ra_ap_salsa-macros/0.0.256/download"],
        strip_prefix = "ra_ap_salsa-macros-0.0.256",
        build_file = Label("//misc/bazel/3rdparty/tree_sitter_extractors_deps:BUILD.ra_ap_salsa-macros-0.0.256.bazel"),
    )

    maybe(
        http_archive,
        name = "vendor__ra_ap_span-0.0.256",
        sha256 = "463076dc7dae01fb08ad5ee6e3692233e1c6860a0e4a7adefedcefa9d82b1e79",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/ra_ap_span/0.0.256/download"],
        strip_prefix = "ra_ap_span-0.0.256",
        build_file = Label("//misc/bazel/3rdparty/tree_sitter_extractors_deps:BUILD.ra_ap_span-0.0.256.bazel"),
    )

    maybe(
        http_archive,
        name = "vendor__ra_ap_stdx-0.0.256",
        sha256 = "f8f053edace81e5f43ec55421a093b43d6be5d62eb4fd737b37663495f798da8",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/ra_ap_stdx/0.0.256/download"],
        strip_prefix = "ra_ap_stdx-0.0.256",
        build_file = Label("//misc/bazel/3rdparty/tree_sitter_extractors_deps:BUILD.ra_ap_stdx-0.0.256.bazel"),
    )

    maybe(
        http_archive,
        name = "vendor__ra_ap_syntax-0.0.256",
        sha256 = "7a87d99597eb7bdd5f3ce99b769cd104ffe271058f314b27f3b1088b79cf6e89",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/ra_ap_syntax/0.0.256/download"],
        strip_prefix = "ra_ap_syntax-0.0.256",
        build_file = Label("//misc/bazel/3rdparty/tree_sitter_extractors_deps:BUILD.ra_ap_syntax-0.0.256.bazel"),
    )

    maybe(
        http_archive,
        name = "vendor__ra_ap_syntax-bridge-0.0.256",
        sha256 = "644fe4bae7992643c58e36111b042e13e690865f90efb1a5018c47b71646dbc4",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/ra_ap_syntax-bridge/0.0.256/download"],
        strip_prefix = "ra_ap_syntax-bridge-0.0.256",
        build_file = Label("//misc/bazel/3rdparty/tree_sitter_extractors_deps:BUILD.ra_ap_syntax-bridge-0.0.256.bazel"),
    )

    maybe(
        http_archive,
        name = "vendor__ra_ap_toolchain-0.0.256",
        sha256 = "225975ceb23cb5917535361c0cf515c695724f580f33d7467279216558d6a84b",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/ra_ap_toolchain/0.0.256/download"],
        strip_prefix = "ra_ap_toolchain-0.0.256",
        build_file = Label("//misc/bazel/3rdparty/tree_sitter_extractors_deps:BUILD.ra_ap_toolchain-0.0.256.bazel"),
    )

    maybe(
        http_archive,
        name = "vendor__ra_ap_tt-0.0.256",
        sha256 = "b59b29f6db1b41e6a844d06e08990ad0b750d5dcab2542815362e93446b8137c",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/ra_ap_tt/0.0.256/download"],
        strip_prefix = "ra_ap_tt-0.0.256",
        build_file = Label("//misc/bazel/3rdparty/tree_sitter_extractors_deps:BUILD.ra_ap_tt-0.0.256.bazel"),
    )

    maybe(
        http_archive,
        name = "vendor__ra_ap_vfs-0.0.256",
        sha256 = "d40a974887cbaecc8e92b537ef826e2cac6f89fe366f4d6e25b0c5b61da4db87",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/ra_ap_vfs/0.0.256/download"],
        strip_prefix = "ra_ap_vfs-0.0.256",
        build_file = Label("//misc/bazel/3rdparty/tree_sitter_extractors_deps:BUILD.ra_ap_vfs-0.0.256.bazel"),
    )

    maybe(
        http_archive,
        name = "vendor__ra_ap_vfs-notify-0.0.256",
        sha256 = "e5449af6c623350f87da8509158ecb278c23013be11b239832ef2fb346712809",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/ra_ap_vfs-notify/0.0.256/download"],
        strip_prefix = "ra_ap_vfs-notify-0.0.256",
        build_file = Label("//misc/bazel/3rdparty/tree_sitter_extractors_deps:BUILD.ra_ap_vfs-notify-0.0.256.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//misc/bazel/3rdparty/tree_sitter_extractors_deps:BUILD.syn-2.0.95.bazel"),
    )
    ...
    return [
        ...
        struct(repo = "vendor__clap-4.5.24", is_dev_dep = False),
        ...
        struct(repo = "vendor__ra_ap_base_db-0.0.256", is_dev_dep = False),
        struct(repo = "vendor__ra_ap_cfg-0.0.256", is_dev_dep = False),
        struct(repo = "vendor__ra_ap_hir-0.0.256", is_dev_dep = False),
        struct(repo = "vendor__ra_ap_hir_def-0.0.256", is_dev_dep = False),
        struct(repo = "vendor__ra_ap_hir_expand-0.0.256", is_dev_dep = False),
        struct(repo = "vendor__ra_ap_ide_db-0.0.256", is_dev_dep = False),
        struct(repo = "vendor__ra_ap_intern-0.0.256", is_dev_dep = False),
        struct(repo = "vendor__ra_ap_load-cargo-0.0.256", is_dev_dep = False),
        struct(repo = "vendor__ra_ap_parser-0.0.256", is_dev_dep = False),
        struct(repo = "vendor__ra_ap_paths-0.0.256", is_dev_dep = False),
        struct(repo = "vendor__ra_ap_project_model-0.0.256", is_dev_dep = False),
        struct(repo = "vendor__ra_ap_span-0.0.256", is_dev_dep = False),
        struct(repo = "vendor__ra_ap_stdx-0.0.256", is_dev_dep = False),
        struct(repo = "vendor__ra_ap_syntax-0.0.256", is_dev_dep = False),
        struct(repo = "vendor__ra_ap_vfs-0.0.256", is_dev_dep = False),
