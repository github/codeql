...
echo 'exports_files(["rust.ungram"])' >> misc/bazel/3rdparty/rust_deps/BUILD.ra_ap_syntax-?.*.bazel

# no idea why this is necessary, see https://github.com/bazelbuild/rules_rust/issues/3255
python3 "$WORKSPACE_DIR/misc/bazel/3rdparty/patch_defs.py" misc/bazel/3rdparty/rust_deps/defs.bzl
