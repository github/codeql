...
module Raw {
  ...
  class Callable extends @callable, Element {
    ...
    ParamDecl getSelfParam() {
      callable_self_params(this, result)
    }
    /**
    ...
    ParamDecl getParam(int index) {
      callable_params(this, index, result)
    }
    /**
    ...
    CapturedDecl getCapture(int index) {
      callable_captures(this, index, result)
    }
  }
  ...
  class File extends @file, Element {
    ...
    predicate isSuccessfullyExtracted() {
      file_is_successfully_extracted(this)
    }
  }
  ...
  class Locatable extends @locatable, Element {
    ...
    Location getLocation() {
      locatable_locations(this, result)
    }
  }
  ...
  class AvailabilityInfo extends @availability_info, AstNode {
    ...
    predicate isUnavailable() {
      availability_info_is_unavailable(this)
    }
    /**
    ...
    AvailabilitySpec getSpec(int index) {
      availability_info_specs(this, index, result)
    }
  }
  ...
  class KeyPathComponent extends @key_path_component, AstNode {
     ...
     */
    int getKind() {
      key_path_components(this, result, _)
    }
    /**
     ...
     */
    int getTupleIndex() {
      key_path_component_tuple_indices(this, result)
    }
    /**
    ...
    ValueDecl getDeclRef() {
      key_path_component_decl_refs(this, result)
    }
    /**
    ...
    Type getComponentType() {
      key_path_components(this, _, result)
    }
  }
  ...
  class UnspecifiedElement extends @unspecified_element, ErrorElement {
     ...
     */
    Element getParent() {
      unspecified_element_parents(this, result)
    }
    /**
     ...
     */
    string getProperty() {
      unspecified_elements(this, result, _)
    }
    /**
     ...
     */
    int getIndex() {
      unspecified_element_indices(this, result)
    }
    /**
     ...
     */
    string getError() {
      unspecified_elements(this, _, result)
    }
  }
   ...
   */
  class PlatformVersionAvailabilitySpec extends @platform_version_availability_spec, AvailabilitySpec {
     ...
     */
    string getPlatform() {
      platform_version_availability_specs(this, result, _)
    }
    /**
     ...
     */
    string getVersion() {
      platform_version_availability_specs(this, _, result)
    }
  }
  ...
  class Decl extends @decl, AstNode {
    ...
    Decl getMember(int index) {
      decl_members(this, index, result)
    }
  }
  ...
  class CapturedDecl extends @captured_decl, Decl {
    ...
    predicate isEscaping() {
      captured_decl_is_escaping(this)
    }
  }
  ...
  class EnumCaseDecl extends @enum_case_decl, Decl {
    ...
    EnumElementDecl getElement(int index) {
      enum_case_decl_elements(this, index, result)
    }
  }
  ...
  class ExtensionDecl extends @extension_decl, GenericContext, Decl {
    ...
    ProtocolDecl getProtocol(int index) {
      extension_decl_protocols(this, index, result)
    }
  }
  ...
  class IfConfigDecl extends @if_config_decl, Decl {
    ...
    AstNode getActiveElement(int index) {
      if_config_decl_active_elements(this, index, result)
    }
  }
  ...
  class ImportDecl extends @import_decl, Decl {
    ...
    ModuleDecl getImportedModule() {
      import_decl_imported_modules(this, result)
    }
    /**
    ...
    ValueDecl getDeclaration(int index) {
      import_decl_declarations(this, index, result)
    }
  }
  ...
  class MissingMemberDecl extends @missing_member_decl, Decl {
     ...
     */
    string getName() {
      missing_member_decls(this, result)
    }
  }
  ...
  class PatternBindingDecl extends @pattern_binding_decl, Decl {
    ...
    Expr getInit(int index) {
      pattern_binding_decl_inits(this, index, result)
    }
    /**
    ...
    Pattern getPattern(int index) {
      pattern_binding_decl_patterns(this, index, result)
    }
  }
  ...
  class PoundDiagnosticDecl extends @pound_diagnostic_decl, Decl {
     ...
     */
    int getKind() {
      pound_diagnostic_decls(this, result, _)
    }
    /**
    ...
    StringLiteralExpr getMessage() {
      pound_diagnostic_decls(this, _, result)
    }
  }
  ...
  class TopLevelCodeDecl extends @top_level_code_decl, Decl {
     ...
     */
    BraceStmt getBody() {
      top_level_code_decls(this, result)
    }
  }
  ...
  class AbstractStorageDecl extends @abstract_storage_decl, ValueDecl {
    ...
    Accessor getAccessor(int index) {
      abstract_storage_decl_accessors(this, index, result)
    }
  }
  ...
  class EnumElementDecl extends @enum_element_decl, ValueDecl {
     ...
     */
    ParamDecl getParam(int index) {
      enum_element_decl_params(this, index, result)
    }
  }
  ...
  class InfixOperatorDecl extends @infix_operator_decl, OperatorDecl {
    ...
    PrecedenceGroupDecl getPrecedenceGroup() {
      infix_operator_decl_precedence_groups(this, result)
    }
  }
  ...
  class TypeDecl extends @type_decl, ValueDecl {
    ...
    Type getBaseType(int index) {
      type_decl_base_types(this, index, result)
    }
  }
  ...
  class ModuleDecl extends @module_decl, TypeDecl {
    ...
    predicate isBuiltinModule() {
      module_decl_is_builtin_module(this)
    }
    /**
    ...
    predicate isSystemModule() {
      module_decl_is_system_module(this)
    }
    /**
...
Gets any of the imported modules of this module declaration.
    ...
    ModuleDecl getAnImportedModule() {
      module_decl_imported_modules(this, result)
    }
    /**
...
Gets any of the exported modules of this module declaration.
    ...
    ModuleDecl getAnExportedModule() {
      module_decl_exported_modules(this, result)
    }
  }
  ...
  class SubscriptDecl extends @subscript_decl, AbstractStorageDecl, GenericContext {
     ...
     */
    ParamDecl getParam(int index) {
      subscript_decl_params(this, index, result)
    }
    /**
  ...
  class VarDecl extends @var_decl, AbstractStorageDecl {
    ...
    Type getAttachedPropertyWrapperType() {
      var_decl_attached_property_wrapper_types(this, result)
    }
    /**
    ...
    Pattern getParentPattern() {
      var_decl_parent_patterns(this, result)
    }
    /**
    ...
    Expr getParentInitializer() {
      var_decl_parent_initializers(this, result)
    }
    /**
    ...
    VarDecl getPropertyWrapperBackingVar() {
      var_decl_property_wrapper_backing_vars(this, result)
    }
    /**
  ...
  class Accessor extends @accessor, AccessorOrNamedFunction {
    ...
    predicate isUnsafeAddress() {
      accessor_is_unsafe_address(this)
    }
    /**
    ...
    predicate isUnsafeMutableAddress() {
      accessor_is_unsafe_mutable_address(this)
    }
  }
  ...
  class ConcreteVarDecl extends @concrete_var_decl, VarDecl {
    ...
    int getIntroducerInt() {
      concrete_var_decls(this, result)
    }
  }
  ...
  class NominalTypeDecl extends @nominal_type_decl, GenericTypeDecl {
     ...
     */
    Type getType() {
      nominal_type_decls(this, result)
    }
  }
  ...
  class AppliedPropertyWrapperExpr extends @applied_property_wrapper_expr, Expr {
     ...
     */
    int getKind() {
      applied_property_wrapper_exprs(this, result, _, _)
    }
    /**
     ...
     */
    Expr getValue() {
      applied_property_wrapper_exprs(this, _, result, _)
    }
    /**
     ...
     */
    ParamDecl getParam() {
      applied_property_wrapper_exprs(this, _, _, result)
    }
  }
  ...
  class ApplyExpr extends @apply_expr, Expr {
    ...
    Argument getArgument(int index) {
      apply_expr_arguments(this, index, result)
    }
  }
  ...
  class BindOptionalExpr extends @bind_optional_expr, Expr {
     ...
     */
    Expr getSubExpr() {
      bind_optional_exprs(this, result)
    }
  }
  ...
  class CaptureListExpr extends @capture_list_expr, Expr {
    ...
    ClosureExpr getClosureBody() {
      capture_list_exprs(this, result)
    }
  }
  ...
  class DeclRefExpr extends @decl_ref_expr, Expr {
    ...
    Type getReplacementType(int index) {
      decl_ref_expr_replacement_types(this, index, result)
    }
    /**
    ...
    predicate hasDirectToStorageSemantics() {
      decl_ref_expr_has_direct_to_storage_semantics(this)
    }
    /**
    ...
    predicate hasOrdinarySemantics() {
      decl_ref_expr_has_ordinary_semantics(this)
    }
    /**
    ...
    predicate hasDistributedThunkSemantics() {
      decl_ref_expr_has_distributed_thunk_semantics(this)
    }
  }
  ...
  class DefaultArgumentExpr extends @default_argument_expr, Expr {
    ...
    ParamDecl getParamDecl() {
      default_argument_exprs(this, result, _)
    }
    /**
    ...
    Expr getCallerSideDefault() {
      default_argument_expr_caller_side_defaults(this, result)
    }
  }
  ...
  class DotSyntaxBaseIgnoredExpr extends @dot_syntax_base_ignored_expr, Expr {
     ...
     */
    Expr getQualifier() {
      dot_syntax_base_ignored_exprs(this, result, _)
    }
    /**
     ...
     */
    Expr getSubExpr() {
      dot_syntax_base_ignored_exprs(this, _, result)
    }
  }
  ...
  class DynamicTypeExpr extends @dynamic_type_expr, Expr {
     ...
     */
    Expr getBase() {
      dynamic_type_exprs(this, result)
    }
  }
  ...
  class EnumIsCaseExpr extends @enum_is_case_expr, Expr {
     ...
     */
    Expr getSubExpr() {
      enum_is_case_exprs(this, result, _)
    }
    /**
    ...
    EnumElementDecl getElement() {
      enum_is_case_exprs(this, _, result)
    }
  }
  ...
  class ExplicitCastExpr extends @explicit_cast_expr, Expr {
     ...
     */
    Expr getSubExpr() {
      explicit_cast_exprs(this, result)
    }
  }
  ...
  class ImplicitConversionExpr extends @implicit_conversion_expr, Expr {
     ...
     */
    Expr getSubExpr() {
      implicit_conversion_exprs(this, result)
    }
  }
  ...
  class KeyPathApplicationExpr extends @key_path_application_expr, Expr {
     ...
     */
    Expr getBase() {
      key_path_application_exprs(this, result, _)
    }
    /**
     ...
     */
    Expr getKeyPath() {
      key_path_application_exprs(this, _, result)
    }
  }
  ...
  class KeyPathExpr extends @key_path_expr, Expr {
     ...
     */
    TypeRepr getRoot() {
      key_path_expr_roots(this, result)
    }
    /**
    ...
    KeyPathComponent getComponent(int index) {
      key_path_expr_components(this, index, result)
    }
  }
  ...
  class LazyInitializationExpr extends @lazy_initialization_expr, Expr {
     ...
     */
    Expr getSubExpr() {
      lazy_initialization_exprs(this, result)
    }
  }
  ...
  class LookupExpr extends @lookup_expr, Expr {
     ...
     */
    Decl getMember() {
      lookup_expr_members(this, result)
    }
  }
  ...
  class MakeTemporarilyEscapableExpr extends @make_temporarily_escapable_expr, Expr {
    ...
    OpaqueValueExpr getEscapingClosure() {
      make_temporarily_escapable_exprs(this, result, _, _)
    }
    /**
    ...
    Expr getNonescapingClosure() {
      make_temporarily_escapable_exprs(this, _, result, _)
    }
    /**
     ...
     */
    Expr getSubExpr() {
      make_temporarily_escapable_exprs(this, _, _, result)
    }
  }
  ...
  class ObjCSelectorExpr extends @obj_c_selector_expr, Expr {
     ...
     */
    Expr getSubExpr() {
      obj_c_selector_exprs(this, result, _)
    }
    /**
     ...
     */
    Function getMethod() {
      obj_c_selector_exprs(this, _, result)
    }
  }
  ...
  class OpenExistentialExpr extends @open_existential_expr, Expr {
     ...
     */
    Expr getSubExpr() {
      open_existential_exprs(this, result, _, _)
    }
    /**
     ...
     */
    Expr getExistential() {
      open_existential_exprs(this, _, result, _)
    }
    /**
    ...
    OpaqueValueExpr getOpaqueExpr() {
      open_existential_exprs(this, _, _, result)
    }
  }
  ...
  class OptionalEvaluationExpr extends @optional_evaluation_expr, Expr {
     ...
     */
    Expr getSubExpr() {
      optional_evaluation_exprs(this, result)
    }
  }
  ...
  class OtherInitializerRefExpr extends @other_initializer_ref_expr, Expr {
    ...
    Initializer getInitializer() {
      other_initializer_ref_exprs(this, result)
    }
  }
  ...
  class PropertyWrapperValuePlaceholderExpr extends @property_wrapper_value_placeholder_expr, Expr {
     ...
     *
     */
    Expr getWrappedValue() {
      property_wrapper_value_placeholder_expr_wrapped_values(this, result)
    }
    /**
    ...
    OpaqueValueExpr getPlaceholder() {
      property_wrapper_value_placeholder_exprs(this, result)
    }
  }
  ...
  class RebindSelfInInitializerExpr extends @rebind_self_in_initializer_expr, Expr {
     ...
     */
    Expr getSubExpr() {
      rebind_self_in_initializer_exprs(this, result, _)
    }
    /**
     ...
     */
    VarDecl getSelf() {
      rebind_self_in_initializer_exprs(this, _, result)
    }
  }
  ...
  class SequenceExpr extends @sequence_expr, Expr {
    ...
    Expr getElement(int index) {
      sequence_expr_elements(this, index, result)
    }
  }
  ...
  class TapExpr extends @tap_expr, Expr {
     ...
     */
    Expr getSubExpr() {
      tap_expr_sub_exprs(this, result)
    }
    /**
  ...
  class TupleElementExpr extends @tuple_element_expr, Expr {
     ...
     */
    Expr getSubExpr() {
      tuple_element_exprs(this, result, _)
    }
    /**
     ...
     */
    int getIndex() {
      tuple_element_exprs(this, _, result)
    }
  }
  ...
  class TupleExpr extends @tuple_expr, Expr {
     ...
     */
    Expr getElement(int index) {
      tuple_expr_elements(this, index, result)
    }
  }
  ...
  class TypeExpr extends @type_expr, Expr {
    ...
    TypeRepr getTypeRepr() {
      type_expr_type_reprs(this, result)
    }
  }
  ...
  class UnresolvedDeclRefExpr extends @unresolved_decl_ref_expr, Expr, ErrorElement {
     ...
     */
    string getName() {
      unresolved_decl_ref_expr_names(this, result)
    }
  }
  ...
  class UnresolvedDotExpr extends @unresolved_dot_expr, Expr, ErrorElement {
     ...
     */
    Expr getBase() {
      unresolved_dot_exprs(this, result, _)
    }
    /**
     ...
     */
    string getName() {
      unresolved_dot_exprs(this, _, result)
    }
  }
  ...
  class UnresolvedMemberExpr extends @unresolved_member_expr, Expr, ErrorElement {
     ...
     */
    string getName() {
      unresolved_member_exprs(this, result)
    }
  }
  ...
  class UnresolvedPatternExpr extends @unresolved_pattern_expr, Expr, ErrorElement {
    ...
    Pattern getSubPattern() {
      unresolved_pattern_exprs(this, result)
    }
  }
  ...
  class UnresolvedSpecializeExpr extends @unresolved_specialize_expr, Expr, ErrorElement {
     ...
     */
    Expr getSubExpr() {
      unresolved_specialize_exprs(this, result)
    }
  }
  ...
  class VarargExpansionExpr extends @vararg_expansion_expr, Expr {
     ...
     */
    Expr getSubExpr() {
      vararg_expansion_exprs(this, result)
    }
  }
  ...
  class ArrayExpr extends @array_expr, CollectionExpr {
     ...
     */
    Expr getElement(int index) {
      array_expr_elements(this, index, result)
    }
  }
   ...
   * INTERNAL: Do not use.
   */
  class CollectionUpcastConversionExpr extends @collection_upcast_conversion_expr, ImplicitConversionExpr {
   ...
   * INTERNAL: Do not use.
   */
  class ConditionalBridgeFromObjCExpr extends @conditional_bridge_from_obj_c_expr, ImplicitConversionExpr {
   ...
   * INTERNAL: Do not use.
   */
  class CovariantFunctionConversionExpr extends @covariant_function_conversion_expr, ImplicitConversionExpr {
   ...
   * INTERNAL: Do not use.
   */
  class CovariantReturnConversionExpr extends @covariant_return_conversion_expr, ImplicitConversionExpr {
  ...
  class DictionaryExpr extends @dictionary_expr, CollectionExpr {
     ...
     */
    Expr getElement(int index) {
      dictionary_expr_elements(this, index, result)
    }
  }
   ...
   * INTERNAL: Do not use.
   */
  class DifferentiableFunctionExtractOriginalExpr extends @differentiable_function_extract_original_expr, ImplicitConversionExpr {
   ...
   * INTERNAL: Do not use.
   */
  class ExistentialMetatypeToObjectExpr extends @existential_metatype_to_object_expr, ImplicitConversionExpr {
  ...
  class InterpolatedStringLiteralExpr extends @interpolated_string_literal_expr, LiteralExpr {
    ...
    TapExpr getAppendingExpr() {
      interpolated_string_literal_expr_appending_exprs(this, result)
    }
  }
   ...
   * INTERNAL: Do not use.
   */
  class LinearFunctionExtractOriginalExpr extends @linear_function_extract_original_expr, ImplicitConversionExpr {
   ...
   * INTERNAL: Do not use.
   */
  class LinearToDifferentiableFunctionExpr extends @linear_to_differentiable_function_expr, ImplicitConversionExpr {
  ...
  class MemberRefExpr extends @member_ref_expr, LookupExpr {
     ...
     */
    predicate hasOrdinarySemantics() {
      member_ref_expr_has_ordinary_semantics(this)
    }
    /**
  ...
  class ObjectLiteralExpr extends @object_literal_expr, LiteralExpr {
     ...
     */
    int getKind() {
      object_literal_exprs(this, result)
    }
    /**
     ...
     */
    Argument getArgument(int index) {
      object_literal_expr_arguments(this, index, result)
    }
  }
   ...
   * INTERNAL: Do not use.
   */
  class ProtocolMetatypeToObjectExpr extends @protocol_metatype_to_object_expr, ImplicitConversionExpr {
  ...
  class RegexLiteralExpr extends @regex_literal_expr, LiteralExpr {
     ...
     */
    string getPattern() {
      regex_literal_exprs(this, result, _)
    }
    /**
     ...
     */
    int getVersion() {
      regex_literal_exprs(this, _, result)
    }
  }
  ...
  class SubscriptExpr extends @subscript_expr, LookupExpr {
     ...
     */
    Argument getArgument(int index) {
      subscript_expr_arguments(this, index, result)
    }
    /**
     ...
     */
    predicate hasDirectToStorageSemantics() {
      subscript_expr_has_direct_to_storage_semantics(this)
    }
    /**
     ...
     */
    predicate hasOrdinarySemantics() {
      subscript_expr_has_ordinary_semantics(this)
    }
    /**
   ...
   * INTERNAL: Do not use.
   */
  class UnresolvedMemberChainResultExpr extends @unresolved_member_chain_result_expr, IdentityExpr, ErrorElement {
   ...
   * INTERNAL: Do not use.
   */
  class UnresolvedTypeConversionExpr extends @unresolved_type_conversion_expr, ImplicitConversionExpr, ErrorElement {
  ...
  class BooleanLiteralExpr extends @boolean_literal_expr, BuiltinLiteralExpr {
     ...
     */
    boolean getValue() {
      boolean_literal_exprs(this, result)
    }
  }
  ...
  class FloatLiteralExpr extends @float_literal_expr, NumberLiteralExpr {
    ...
    string getStringValue() {
      float_literal_exprs(this, result)
    }
  }
  ...
  class EnumElementPattern extends @enum_element_pattern, Pattern {
     ...
     */
    EnumElementDecl getElement() {
      enum_element_patterns(this, result)
    }
    /**
     ...
     */
    Pattern getSubPattern() {
      enum_element_pattern_sub_patterns(this, result)
    }
  }
  ...
  class IsPattern extends @is_pattern, Pattern {
    ...
    TypeRepr getCastTypeRepr() {
      is_pattern_cast_type_reprs(this, result)
    }
    /**
     ...
     */
    Pattern getSubPattern() {
      is_pattern_sub_patterns(this, result)
    }
  }
  ...
  class OptionalSomePattern extends @optional_some_pattern, Pattern {
     ...
     */
    Pattern getSubPattern() {
      optional_some_patterns(this, result)
    }
  }
  ...
  class TuplePattern extends @tuple_pattern, Pattern {
    ...
    Pattern getElement(int index) {
      tuple_pattern_elements(this, index, result)
    }
  }
  ...
  class TypedPattern extends @typed_pattern, Pattern {
     ...
     */
    TypeRepr getTypeRepr() {
      typed_pattern_type_reprs(this, result)
    }
  }
  ...
  class CaseLabelItem extends @case_label_item, AstNode {
     ...
     */
    Expr getGuard() {
      case_label_item_guards(this, result)
    }
  }
  ...
  class ConditionElement extends @condition_element, AstNode {
     ...
     */
    Expr getBoolean() {
      condition_element_booleans(this, result)
    }
    /**
     ...
     */
    Pattern getPattern() {
      condition_element_patterns(this, result)
    }
    /**
     ...
     */
    Expr getInitializer() {
      condition_element_initializers(this, result)
    }
    /**
    ...
    AvailabilityInfo getAvailability() {
      condition_element_availabilities(this, result)
    }
  }
  ...
  class StmtCondition extends @stmt_condition, AstNode {
    ...
    ConditionElement getElement(int index) {
      stmt_condition_elements(this, index, result)
    }
  }
  ...
  class BraceStmt extends @brace_stmt, Stmt {
    ...
    AstNode getElement(int index) {
      brace_stmt_elements(this, index, result)
    }
  }
  ...
  class BreakStmt extends @break_stmt, Stmt {
    ...
    string getTargetName() {
      break_stmt_target_names(this, result)
    }
    /**
     ...
     */
    Stmt getTarget() {
      break_stmt_targets(this, result)
    }
  }
  ...
  class CaseStmt extends @case_stmt, Stmt {
    ...
    CaseLabelItem getLabel(int index) {
      case_stmt_labels(this, index, result)
    }
    /**
    ...
    VarDecl getVariable(int index) {
      case_stmt_variables(this, index, result)
    }
  }
  ...
  class ContinueStmt extends @continue_stmt, Stmt {
     ...
     */
    Stmt getTarget() {
      continue_stmt_targets(this, result)
    }
  }
  ...
  class FallthroughStmt extends @fallthrough_stmt, Stmt {
    ...
    CaseStmt getFallthroughSource() {
      fallthrough_stmts(this, result, _)
    }
    /**
    ...
    CaseStmt getFallthroughDest() {
      fallthrough_stmts(this, _, result)
    }
  }
  ...
  class PoundAssertStmt extends @pound_assert_stmt, Stmt {
     ...
     */
    Expr getCondition() {
      pound_assert_stmts(this, result, _)
    }
    /**
     ...
     */
    string getMessage() {
      pound_assert_stmts(this, _, result)
    }
  }
  ...
  class ReturnStmt extends @return_stmt, Stmt {
     ...
     */
    Expr getResult() {
      return_stmt_results(this, result)
    }
  }
  ...
  class YieldStmt extends @yield_stmt, Stmt {
    ...
    Expr getResult(int index) {
      yield_stmt_results(this, index, result)
    }
  }
  ...
  class DoCatchStmt extends @do_catch_stmt, LabeledStmt {
    ...
    CaseStmt getCatch(int index) {
      do_catch_stmt_catches(this, index, result)
    }
  }
  ...
  class ForEachStmt extends @for_each_stmt, LabeledStmt {
     ...
     */
    Expr getWhere() {
      for_each_stmt_wheres(this, result)
    }
    /**
    ...
    PatternBindingDecl getIteratorVar() {
      for_each_stmt_iterator_vars(this, result)
    }
    /**
     ...
     */
    Expr getNextCall() {
      for_each_stmt_next_calls(this, result)
    }
    /**
  ...
  class LabeledConditionalStmt extends @labeled_conditional_stmt, LabeledStmt {
    ...
    StmtCondition getCondition() {
      labeled_conditional_stmts(this, result)
    }
  }
  ...
  class RepeatWhileStmt extends @repeat_while_stmt, LabeledStmt {
     ...
     */
    Expr getCondition() {
      repeat_while_stmts(this, result, _)
    }
    /**
     ...
     */
    Stmt getBody() {
      repeat_while_stmts(this, _, result)
    }
  }
  ...
  class SwitchStmt extends @switch_stmt, LabeledStmt {
    ...
    CaseStmt getCase(int index) {
      switch_stmt_cases(this, index, result)
    }
  }
  ...
  class AnyFunctionType extends @any_function_type, Type {
     ...
     */
    Type getResult() {
      any_function_types(this, result)
    }
    /**
    ...
    Type getParamType(int index) {
      any_function_type_param_types(this, index, result)
    }
    /**
    ...
    predicate isThrowing() {
      any_function_type_is_throwing(this)
    }
    /**
     ...
     */
    predicate isAsync() {
      any_function_type_is_async(this)
    }
  }
  ...
  class AnyGenericType extends @any_generic_type, Type {
     ...
     */
    Type getParent() {
      any_generic_type_parents(this, result)
    }
    /**
  ...
  class DependentMemberType extends @dependent_member_type, Type {
     ...
     */
    Type getBaseType() {
      dependent_member_types(this, result, _)
    }
    /**
    ...
    AssociatedTypeDecl getAssociatedTypeDecl() {
      dependent_member_types(this, _, result)
    }
  }
  ...
  class DynamicSelfType extends @dynamic_self_type, Type {
    ...
    Type getStaticSelfType() {
      dynamic_self_types(this, result)
    }
  }
  ...
  class ParameterizedProtocolType extends @parameterized_protocol_type, Type {
     ...
     *
     */
    ProtocolType getBase() {
      parameterized_protocol_types(this, result)
    }
    /**
     * Gets the `index`th argument of this parameterized protocol type (0-based).
     *
     */
    Type getArg(int index) {
      parameterized_protocol_type_args(this, index, result)
    }
  }
  ...
  class ProtocolCompositionType extends @protocol_composition_type, Type {
    ...
    Type getMember(int index) {
      protocol_composition_type_members(this, index, result)
    }
  }
  ...
  class ReferenceStorageType extends @reference_storage_type, Type {
    ...
    Type getReferentType() {
      reference_storage_types(this, result)
    }
  }
  ...
  class TupleType extends @tuple_type, Type {
    ...
    Type getType(int index) {
      tuple_type_types(this, index, result)
    }
    /**
    ...
    string getName(int index) {
      tuple_type_names(this, index, result)
    }
  }
  ...
  class ArchetypeType extends @archetype_type, SubstitutableType {
     ...
     */
    Type getSuperclass() {
      archetype_type_superclasses(this, result)
    }
    /**
     ...
     */
    ProtocolDecl getProtocol(int index) {
      archetype_type_protocols(this, index, result)
    }
  }
   ...
   * INTERNAL: Do not use.
   */
  class NominalOrBoundGenericNominalType extends @nominal_or_bound_generic_nominal_type, AnyGenericType {
  ...
  class BoundGenericType extends @bound_generic_type, NominalOrBoundGenericNominalType {
    ...
    Type getArgType(int index) {
      bound_generic_type_arg_types(this, index, result)
    }
  }
  ...
  class BuiltinIntegerType extends @builtin_integer_type, AnyBuiltinIntegerType {
     ...
     */
    int getWidth() {
      builtin_integer_type_widths(this, result)
    }
  }
  ...
  class DictionaryType extends @dictionary_type, SyntaxSugarType {
     ...
     */
    Type getKeyType() {
      dictionary_types(this, result, _)
    }
    /**
     ...
     */
    Type getValueType() {
      dictionary_types(this, _, result)
    }
  }
  ...
  class OpaqueTypeArchetypeType extends @opaque_type_archetype_type, ArchetypeType {
    ...
    OpaqueTypeDecl getDeclaration() {
      opaque_type_archetype_types(this, result)
    }
  }
  ...
  class UnarySyntaxSugarType extends @unary_syntax_sugar_type, SyntaxSugarType {
     ...
     */
    Type getBaseType() {
      unary_syntax_sugar_types(this, result)
    }
  }
