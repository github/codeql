...
class AnyFunctionTypeBase extends Synth::TAnyFunctionType, Type {
  ...
  string getParamLabel(int index) {
    result = Synth::convertAnyFunctionTypeToDb(this).(Db::AnyFunctionType).getParamLabel(index)
  }
  ...
  predicate isThrowing() {
    Synth::convertAnyFunctionTypeToDb(this).(Db::AnyFunctionType).isThrowing()
  }

  predicate isAsync() { Synth::convertAnyFunctionTypeToDb(this).(Db::AnyFunctionType).isAsync() }
}
