...
class IfStmtBase extends Synth::TIfStmt, LabeledConditionalStmt {
  ...
  Stmt getImmediateThen() {
    result = Synth::convertStmtFromDb(Synth::convertIfStmtToDb(this).(Db::IfStmt).getThen())
  }

  final Stmt getThen() { result = getImmediateThen().resolve() }

  Stmt getImmediateElse() {
    result = Synth::convertStmtFromDb(Synth::convertIfStmtToDb(this).(Db::IfStmt).getElse())
  }
