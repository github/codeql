...
module Generated {
  class CaptureListExpr extends Synth::TCaptureListExpr, Expr {
     ...
     * behavior of both the `Immediate` and non-`Immediate` versions.
     */
    AbstractClosureExpr getImmediateClosureBody() {
      result =
        Synth::convertAbstractClosureExprFromRaw(Synth::convertCaptureListExprToRaw(this)
              .(Raw::CaptureListExpr)
              .getClosureBody())
    }
     ...
     * Gets the closure body of this capture list expression.
     */
    final AbstractClosureExpr getClosureBody() { result = getImmediateClosureBody().resolve() }
  }
}
