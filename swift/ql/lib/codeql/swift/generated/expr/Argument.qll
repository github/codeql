...
class ArgumentBase extends Synth::TArgument, Locatable {
  ...
  string getLabel() { result = Synth::convertArgumentToDb(this).(Db::Argument).getLabel() }

  Expr getImmediateExpr() {
    result = Synth::convertExprFromDb(Synth::convertArgumentToDb(this).(Db::Argument).getExpr())
  }
