...
func testUnsafePointers() {
  ...
  sink(arg: ptr1[0]) // $ MISSING: tainted=ptr1
  ...
  sink(arg: ptr2.move()) // $ MISSING: tainted=ptr2
  ...
  sink(arg: ptr3[0]) // $ MISSING: tainted=ptr3
  ...
  sink(arg: ptr4[0]) // $ MISSING: tainted=ptr1
}
...
func testRawPointers() {
  ...
  sink(arg: raw1.load(fromByteOffset: 0, as: Int.self)) // $ MISSING: tainted=raw1
  ...
  sink(arg: raw3.load(fromByteOffset: 0, as: Int.self)) // $ MISSING: tainted=raw1
  let raw4 = UnsafeRawBufferPointer(start: raw3, count: MemoryLayout<Int>.size)
  sink(arg: raw4[0]) // $ MISSING: tainted=raw1
}
...
func testRawPointerConversion() {
  ...
  withUnsafeMutableBytes(of: &i2, {
    ...
    let ptr2 = UnsafeRawBufferPointer(ptr)
    sink(arg: ptr2[0]) // $ MISSING: tainted=i2

    let ptr3 = UnsafeMutableRawBufferPointer(ptr)
    sink(arg: ptr3[0]) // $ MISSING: tainted=i2
  })
}
