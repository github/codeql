...
query predicate instances(
  ElementArchetypeType x, string getName__label, string getName, string getCanonicalType__label,
...
query predicate getSuperclass(ElementArchetypeType x, Type getSuperclass) {
  toBeTested(x) and not x.isUnknown() and getSuperclass = x.getSuperclass()
}

query predicate getProtocol(ElementArchetypeType x, int index, ProtocolDecl getProtocol) {
