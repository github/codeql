...
/**
 * Models members of the `cherrypy.request` class as a `RemoteFlowSource`
 */
...
module CorsBypass implements DataFlow::ConfigSig {
...
module CorsFlow = TaintTracking::Global<CorsBypass>;
