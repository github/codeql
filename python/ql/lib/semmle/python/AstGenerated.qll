...
class TemplateStringPart_ extends @py_TemplateStringPart {
  /** Gets the text of this string part of a template string. */
  string getText() { py_strs(result, this, 0) }

  /** Gets the location of this string part of a template string. */
  Location getLocation() { py_locations(result, this) }

  /** Gets a textual representation of this element. */
  string toString() { result = "TemplateStringPart" }
}
