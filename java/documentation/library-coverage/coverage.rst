...
.. csv-table::
   ...
   `Apache Commons IO <https://commons.apache.org/proper/commons-io/>`_,``org.apache.commons.io``,,570,124,102,,,,,15
   ...
   `Google Guava <https://guava.dev/>`_,``com.google.common.*``,,730,43,4,,,,,
   ...
   Java Standard Library,``java.*``,10,4629,260,59,,9,,,26
   Java extensions,"``javax.*``, ``jakarta.*``",101,4185,90,8,4,2,1,1,4
   `Jetty <https://eclipse.dev/jetty/>`_,``org.eclipse.jetty.client``,,,2,,,,,,2
   Kotlin Standard Library,``kotlin*``,,1849,16,11,,,,,2
   `MongoDB <https://www.mongodb.com/>`_,``com.mongodb``,,,10,,,,,,
   `Netty <https://netty.io/>`_,``io.netty.*``,15,490,23,3,,,,,16
