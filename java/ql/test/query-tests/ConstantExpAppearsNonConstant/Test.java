...
class Test{
	...
	int mul_is_constant_int_left = (0+0) * rnd.nextInt(); // $ Alert //NOT OK
	int mul_is_constant_int_right = rnd.nextInt() * (1-1); // $ Alert //NOT OK
	long mul_is_constant_hex = rnd.nextLong() * (0x0F & 0xF0); // $ Alert //NOT OK
	long mul_is_constant_binary = rnd.nextLong() * (0b010101 & 0b101010); // $ Alert //NOT OK
	...
	int rem_is_constant_int = rnd.nextInt() % 1; // $ Alert //NOT OK
	double rem_is_constant_float = rnd.nextDouble() % 1; //OK (remainder by 1 on floats is not constant)
	long rem_is_constant_hex = rnd.nextLong() % 0x1; // $ Alert //NOT OK
	long rem_is_constant_binary = rnd.nextLong() % 01; // $ Alert //NOT OK
	...
	int band_is_constant_left = 0 & rnd.nextInt(); // $ Alert //NOT OK
	int band_is_constant_right = rnd.nextInt() & 0; // $ Alert //NOT OK
	...
	boolean or_is_constant_left = true || (rnd.nextInt() > 0); // $ Alert //NOT OK
	boolean or_is_constant_right = (rnd.nextInt() > 0) || true; // $ Alert //NOT OK
	}
}
