...
public class RequestEntity<T> extends org.springframework.http.HttpEntity<T>
{
    ...
    {
        <T> org.springframework.http.RequestEntity<T> body(T p0);
        <T> org.springframework.http.RequestEntity<T> body(T p0, Type p1);
