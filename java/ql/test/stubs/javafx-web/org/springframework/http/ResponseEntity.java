...
public class ResponseEntity<T> extends org.springframework.http.HttpEntity<T>
{
    ...
    public static <T> org.springframework.http.ResponseEntity<T> of(java.util.Optional<T> p0){ return null; }
    public static <T> org.springframework.http.ResponseEntity<T> ok(T p0){ return null; }
    ...
    public static ResponseEntity.BodyBuilder internalServerError(){ return null; }
    ...
    {
        <T> org.springframework.http.ResponseEntity<T> body(T p0);
