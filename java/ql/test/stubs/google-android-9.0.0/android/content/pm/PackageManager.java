...
abstract public class PackageManager
{
    ...
    public List<PackageManager.Property> queryActivityProperty(String p0){ return null; }
    public List<PackageManager.Property> queryApplicationProperty(String p0){ return null; }
    public List<PackageManager.Property> queryProviderProperty(String p0){ return null; }
    public List<PackageManager.Property> queryReceiverProperty(String p0){ return null; }
    public List<PackageManager.Property> queryServiceProperty(String p0){ return null; }
    ...
    public PackageManager.Property getProperty(String p0, ComponentName p1){ return null; }
    public PackageManager.Property getProperty(String p0, String p1){ return null; }
    public Resources getResourcesForApplication(ApplicationInfo p0, Configuration p1){ return null; }
    ...
    public int getTargetSdkVersion(String p0){ return 0; }
    public static List<Certificate> TRUST_ALL = null;
    public static List<Certificate> TRUST_NONE = null;
    ...
    public static String FEATURE_HARDWARE_KEYSTORE = null;
    public static String FEATURE_HIFI_SENSORS = null;
    public static String FEATURE_HOME_SCREEN = null;
    public static String FEATURE_IDENTITY_CREDENTIAL_HARDWARE = null;
    public static String FEATURE_IDENTITY_CREDENTIAL_HARDWARE_DIRECT_ACCESS = null;
    ...
    public static String FEATURE_KEYSTORE_APP_ATTEST_KEY = null;
    public static String FEATURE_KEYSTORE_LIMITED_USE_KEY = null;
    public static String FEATURE_KEYSTORE_SINGLE_USE_KEY = null;
    ...
    public static String FEATURE_OPENGLES_DEQP_LEVEL = null;
    ...
    public static String FEATURE_SECURITY_MODEL_COMPATIBLE = null;
    ...
    public static String PROPERTY_MEDIA_CAPABILITIES = null;
    ...
    public static int GET_ATTRIBUTIONS = 0;
    ...
    public static int INSTALL_SCENARIO_BULK = 0;
    public static int INSTALL_SCENARIO_BULK_SECONDARY = 0;
    public static int INSTALL_SCENARIO_DEFAULT = 0;
    public static int INSTALL_SCENARIO_FAST = 0;
    ...
    public void getGroupOfPlatformPermission(String p0, Executor p1, Consumer<String> p2){}
    public void getPlatformPermissionsForGroup(String p0, Executor p1, Consumer<List<String>> p2){}
    public void requestChecksums(String p0, boolean p1, int p2, List<Certificate> p3, PackageManager.OnChecksumsReadyListener p4){}
    ...
    static public class Property implements Parcelable
    {
        ...
        public boolean isResourceId(){ return false; }
        public boolean isString(){ return false; }
        public float getFloat(){ return 0; }
        public int describeContents(){ return 0; }
        public int getInteger(){ return 0; }
        public int getResourceId(){ return 0; }
        public static Parcelable.Creator<PackageManager.Property> CREATOR = null;
        public void writeToParcel(Parcel p0, int p1){}
    }
    static public interface OnChecksumsReadyListener
    {
