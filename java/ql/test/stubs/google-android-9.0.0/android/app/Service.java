 ...
 * calls {@link android.content.Context#startService Context.startService()}
 ...
 *
 * <p>
 * Clients can also use {@link android.content.Context#bindService
 * Context.bindService()} to
 ...
 * consequence of this is that if you implement {@link #onStartCommand
 * onStartCommand()}
 ...
 *
 * {@sample development/samples/ApiDemos/AndroidManifest.xml
 * remote_service_declaration}
 *
 * <p>
...
public abstract class Service extends ContextWrapper {
     ...
     * calling
     * {@link android.content.Context#startService}, providing the arguments it
     * supplied and a
     ...
     *                after
     *                its process has gone away, and it had previously returned
     *                anything
