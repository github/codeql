// Generated automatically from com.fasterxml.jackson.core.JsonGenerator for testing purposes
...
abstract public class JsonGenerator implements Closeable, Flushable, Versioned
{
    ...
    public JsonGenerator overrideFormatFeatures(int p0, int p1){ return null; }
    public JsonGenerator overrideStdFeatures(int p0, int p1){ return null; }
    ...
    public void writeArray(double[] p0, int p1, int p2){}
    public void writeArray(int[] p0, int p1, int p2){}
    public void writeArray(long[] p0, int p1, int p2){}
    ...
    public void writeRawValue(SerializableString p0){}
    public void writeStartArray(int p0){}
    public void writeStartObject(Object p0){}
    public void writeStringField(String p0, String p1){}
    public void writeTypeId(Object p0){}
    static public enum Feature
    {
        AUTO_CLOSE_JSON_CONTENT, AUTO_CLOSE_TARGET, ESCAPE_NON_ASCII, FLUSH_PASSED_TO_STREAM, IGNORE_UNKNOWN, QUOTE_FIELD_NAMES, QUOTE_NON_NUMERIC_NUMBERS, STRICT_DUPLICATE_DETECTION, WRITE_BIGDECIMAL_AS_PLAIN, WRITE_NUMBERS_AS_STRINGS;
        private Feature() {}
