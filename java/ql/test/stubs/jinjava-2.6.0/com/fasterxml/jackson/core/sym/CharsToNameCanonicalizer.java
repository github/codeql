// Generated automatically from com.fasterxml.jackson.core.sym.CharsToNameCanonicalizer for testing
// purposes
...
public class CharsToNameCanonicalizer {
    ...
    protected static CharsToNameCanonicalizer createRoot(int p0) {
        return null;
    }
    ...
    public CharsToNameCanonicalizer makeChild(int p0) {
        return null;
    }

    public String findSymbol(char[] p0, int p1, int p2, int p3) {
        return null;
    }
    ...
    public int _hashToIndex(int p0) {
        return 0;
    }
    ...
    public int calcHash(String p0) {
        return 0;
    }

    public int calcHash(char[] p0, int p1, int p2) {
        return 0;
    }
