...
class StrBuilderTest {
    ...
    void test() throws Exception {
        ...
        sink(fluentTest.append("Harmless").append(taint()).append("Also harmless").toString()); // $hasTaintFlow=y

        StrBuilder fluentBackflowTest = new StrBuilder();
        fluentBackflowTest.append("Harmless").append(taint()).append("Also harmless");
        sink(fluentBackflowTest.toString()); // $hasTaintFlow=y
        ...
        sink(fluentBackflowTest2.toString()); // $hasTaintFlow=y
    }
