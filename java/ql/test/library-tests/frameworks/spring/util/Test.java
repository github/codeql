...
public class Test {
	...
	public void test() throws Exception {
		...
		}
		{
			...
			MultiValueMap out = null;
			MultiValueMap in = (MultiValueMap)newWithMapValue(source());
			out = CollectionUtils.unmodifiableMultiValueMap(in);
			sink(getMapValue(out)); // $hasValueFlow
		}
		{
		...
		}
		{
			...
			Object out = null;
			CompositeIterator in = (CompositeIterator)newWithElement(source());
			out = in.next();
		...
		}
		{
			...
			LinkedMultiValueMap out = null;
			LinkedMultiValueMap in = (LinkedMultiValueMap)newWithMapKey(source());
			out = in.deepCopy();
			sink(getMapValue(out)); // $hasValueFlow
		}
		{
			...
			LinkedMultiValueMap out = null;
			LinkedMultiValueMap in = (LinkedMultiValueMap)newWithMapValue(source());
			out = in.deepCopy();
			sink(getMapValue(out)); // $hasValueFlow
		}
		{
		...
		}
		{
			...
			Object out = null;
			MultiValueMapAdapter in = (MultiValueMapAdapter)newWithMapValue(newWithElement(source()));
		...
		}
		{
			...
			Map out = null;
			MultiValueMapAdapter in = (MultiValueMapAdapter)newWithMapKey(source());
			out = in.toSingleValueMap();
			sink(getMapKey(out)); // $hasValueFlow
		}
		{
		...
		}
		{
			...
			String[] out = null;
			Enumeration in = (Enumeration)source();
