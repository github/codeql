  ...
  override predicate row(string row) {
    row =
      [
        ...
        "kotlin.collections;ArraysKt;false;copyOfRange;(Object[],int,int);;Argument[0].ArrayElement;ReturnValue;taint;generated",
        "kotlin.collections;ArraysKt;false;copyOfRange;(byte[],int,int);;Argument[0];ReturnValue;taint;generated",
        "kotlin.collections;ArraysKt;false;copyOfRange;(char[],int,int);;Argument[0];ReturnValue;taint;generated",
        ...
        "kotlin.jvm.internal;TypeReference;false;getPlatformTypeUpperBound$kotlin_stdlib;();;Argument[-1];ReturnValue;taint;generated",
