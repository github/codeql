...
predicate constCond(BinaryExpr cond, boolean isTrue, Reason reason) {
  exists(
    ComparisonExpr comp, Expr lesser, Expr greater, Bound b, QlBuiltins::BigInt d1, QlBuiltins::BigInt d2, Reason r1, Reason r2
  |
    comp = cond and
  ...
  |
    exists(Bound b, QlBuiltins::BigInt d1, QlBuiltins::BigInt d2, boolean upper, Reason r1, Reason r2 |
