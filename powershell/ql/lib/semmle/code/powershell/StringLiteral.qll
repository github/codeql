...
{
    int getNumContinuations()
    {
        string_literal_line(this, result, _)
    }
    string getContinuation(int index)
    {
        string_literal_line(this, index, result)
    }
    ...
    SourceLocation getLocation(){
        string_literal_location(this, result)
    }
}