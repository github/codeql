...
namespace System
{
    public static class Console
    {
        ...
        public static void MoveBufferArea(int sourceLeft, int sourceTop, int sourceWidth, int sourceHeight, int targetLeft, int targetTop, char sourceChar, System.ConsoleColor sourceForeColor, System.ConsoleColor sourceBackColor) => throw null;
        ...
        public static void Write(char value) => throw null;
        public static void Write(char[] buffer) => throw null;
        public static void Write(char[] buffer, int index, int count) => throw null;
        public static void Write(decimal value) => throw null;
        public static void Write(double value) => throw null;
        public static void Write(int value) => throw null;
        public static void Write(long value) => throw null;
        ...
        public static void WriteLine(char value) => throw null;
        public static void WriteLine(char[] buffer) => throw null;
        public static void WriteLine(char[] buffer, int index, int count) => throw null;
        public static void WriteLine(decimal value) => throw null;
        public static void WriteLine(double value) => throw null;
        public static void WriteLine(int value) => throw null;
        public static void WriteLine(long value) => throw null;
