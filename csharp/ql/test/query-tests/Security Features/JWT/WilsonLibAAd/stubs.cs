...
{
    public class AadTokenValidationParametersExtension : Microsoft.IdentityModel.Tokens.TokenValidationParameters
    {
        public void EnableAadSigningKeyIssuerValidation() {}
    }
}