...
where mc.getTarget().hasName("Encrypt")
  and mc.getTarget().getDeclaringType().hasQualifiedName("System.Security.Cryptography", "RSACryptoServiceProvider")
  and mc.getArgument(1) = b
  and b.getValue() = "false"
