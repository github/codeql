 ...
 */
module LockElements {
  TranslatedLockedVarDecl getLockedVarDecl(LockStmt generatedBy) {
    result.getAST() = generatedBy
  }
  
  TranslatedLockTry getTry(LockStmt generatedBy) {
    result.getAST() = generatedBy
  }
...
private class TranslatedMonitorExit extends TranslatedCompilerGeneratedCall, 
  ...
  override TranslatedExprBlueprint getArgument(int id) {
     id = 0 and
  ...
  override predicate hasArguments() { any() }
  
  override TranslatedExprBlueprint getQualifier() { none() }
...
private class TranslatedFinallyIf extends TranslatedCompilerGeneratedIfStmt,
  ...
  override TranslatedCompilerGeneratedCall getElse() {
    none()
  }
}
...
private class TranslatedLockWasTakenDecl extends TranslatedCompilerGeneratedDeclaration,
  ...
  override Type getVarType() {
    result = getInitialization().getResultType()
  }
...
private class TranslatedLockedVarDecl extends TranslatedCompilerGeneratedDeclaration,
  ...
  override TranslatedExprBlueprint getInitialization() {
    result = getTranslatedExpr(generatedBy.getExpr())
  }
  
  override Type getVarType() {
    result = generatedBy.getExpr().getType()
  }
...
private class TranslatedLockWasTakenCondVarAcc extends TTranslatedCompilerGeneratedElement,
  ...
  TranslatedLockWasTakenCondVarAcc() {
...
private class TranslatedLockWasTakenRefArg extends TTranslatedCompilerGeneratedElement,
  ...
  TranslatedLockWasTakenRefArg() {
    this = TTranslatedCompilerGeneratedElement(generatedBy, 13)
  }
