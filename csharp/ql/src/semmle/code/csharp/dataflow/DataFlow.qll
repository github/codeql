...
module DataFlow {
  ...
  module Internal {
    ...
    private module Pruning {
      ...
      private predicate nodeCandFwd1(Node node, Configuration config) {
        ...
        (
          ...
          or
          exists(Node mid | nodeCandFwd1(mid, config) | flowOutOfCallableStep(_, mid, node, _))
        )
      }
      ...
      private predicate nodeCand1(Node node, Configuration config) {
        ...
        (
          ...
          or
          exists(Node mid | nodeCand1(mid, config) | flowOutOfCallableStep(_, node, mid, _))
        )
      }
      ...
      private predicate flowOutOfCallableStepCand1(
        ...
        flowOutOfCallableStep(call, ret, out, _)
      }
      ...
      private predicate flowOutOfCallableStepCandFwd2(
        ...
        flowOutOfCallableStep(call, ret, out, cc)
      }
    ...
    module Cached {
       ...
       */
      cached
      predicate flowOutOfCallableStep(CallNode call, ReturnNode ret, OutNode out, CallContext cc) {
