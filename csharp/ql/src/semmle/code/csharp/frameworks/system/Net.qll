...
class SystemNetClass extends Class {
  SystemNetClass() {
    this.getNamespace() instanceof SystemNetNamespace
  }
}
...
class SystemNetHttpListenerResponseClass extends SystemNetClass {
  SystemNetHttpListenerResponseClass() {
    this.hasName("HttpListenerResponse")
  }

  /** Gets the `OutputStream` Property. */
  Property getOutputStreamProperty() {
    result = this.getProperty("OutputStream")
  }
}
...
class SystemNetHttpListenerRequestClass extends SystemNetClass {
  SystemNetHttpListenerRequestClass() {
    this.hasName("HttpListenerRequest")
  }
}
...
class SystemNetDnsClass extends SystemNetClass {
  ...
  Method getGetHostByAddressMethod() {
    result = this.getAMethod("GetHostByAddress")
  }
}

/** The `System.Net.IPHostEntry` class. */
class SystemNetIPHostEntryClass extends SystemNetClass {
  SystemNetIPHostEntryClass() {
    this.hasName("IPHostEntry")
  }

  /** Gets the `HostName` property. */
  Property getHostNameProperty() {
    result = this.getProperty("HostName")
  }

  /** Gets the `Aliases` property. */
  Property getAliasesProperty() {
    result = this.getProperty("Aliases")
  }
}

/** The `System.Net.Cookie` class. */
class SystemNetCookieClass extends SystemNetClass {
  SystemNetCookieClass() {
    this.hasName("Cookie")
  }
