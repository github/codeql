...
class SystemDataInterface extends Interface {
  SystemDataInterface() {
    this.getNamespace() instanceof SystemDataNamespace
  }
}

/** The `System.Data.IDbCommand` interface. */
class SystemDataIDbCommandInterface extends SystemDataInterface {
  SystemDataIDbCommandInterface() {
    this.hasName("IDbCommand")
  }
...
class SystemDataIDbConnectionInterface extends SystemDataInterface {
  SystemDataIDbConnectionInterface() {
    this.hasName("IDbConnection")
  }

  /** Gets the `ConnectionString` property. */
  Property getAConnectionStringProperty() {
    result = this.getProperty("ConnectionString")
  }
}
...
class SystemDataConnectionClass extends Class {
  ...
  /** Gets the `ConnectionString` property. */
  Property getConnectionStringProperty() {
    result = this.getProperty("ConnectionString")
  }
}
