...
predicate generateRandomNumberMethod(string s)
{
  s="Next" or s="NextBytes" or s="NextDouble"
}

from ObjectCreation c, MethodCall m
where c.getType().getSourceDeclaration().(ValueOrRefType).hasQualifiedName("System","Random") and
