...
private import CaptureTypeBasedSummaryModels as TypeBasedModels
...
module Private {
  ...
  module External {
    ...
    private class TypeBasedSummarizedCallable extends SummarizedCallable {
      private AccessPath inSpec;
      private AccessPath outSpec;

      TypeBasedSummarizedCallable() {
        this.fromLibrary() and
        not this instanceof SummarizedCallableExternal and
        TypeBasedModels::spec(this, inSpec, outSpec)
      }
      ...
      override predicate isAutoGenerated() { any() }
    }
