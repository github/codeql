...
namespace Semmle.Extraction.CSharp.Entities
{
    public class File : Extraction.Entities.File
    {
        ...
        public override void Populate(TextWriter trapFile)
        {
            ...
            var trees = ((CSharp.Context)Context).Compilation.SyntaxTrees.Where(t => t.FilePath == originalPath);
        ...
        private class FileFactory : ICachedEntityFactory<string, File>
        {
            ...
            public File Create(Extraction.Context cx, string init) => new File((Context)cx, init);
        }
    }
}
