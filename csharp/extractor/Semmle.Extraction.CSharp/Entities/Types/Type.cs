            ...
            switch (Symbol.SpecialType)
            {
                ...
                default:
                    ...
                    switch (Symbol.TypeKind)
                    {
                        ...
                        case TypeKind.Error:
                            // Workaround for a bug in Roslyn, where (in some cases) these types appear
                            // twice in the same compilation as both error types and classes
                            if (Symbol.Name is "Stack" or "Dictionary" && Symbol.ContainingNamespace.ToString() is "System.Collections.Generic")
                                return Kinds.TypeKind.CLASS;
