...
{
    internal class AssemblyPath(string p, Func<string, bool> includeFileName)
    {
        ...
        /// <summary>
        /// Finds all assemblies in `path` that should be indexed and adds them to 
        ...
        public override bool Equals(object? obj) => p.Equals(obj);
