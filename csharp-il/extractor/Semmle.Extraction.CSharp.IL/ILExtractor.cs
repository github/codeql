...
public class ILExtractor
{
    ...
    public void Extract(string dllPath)
    {
        ...
        trap.WriteTuple("assemblies", assemblyId, fileId, assembly.Name.Name, assembly.Name.Version.ToString());
    ...
    private void ExtractMethodBody(MethodDefinition method, int methodId)
    {
        ...
        foreach (var instruction in body.Instructions)
        {
            ...
            trap.WriteTuple("il_instructions", 
                instrId, 
            ...
            else if (instruction.Operand is MethodReference methodRef)
            {
                ...
                var targetMethodName = $"{methodRef.DeclaringType.FullName}.{methodRef.Name}";
        ...
        if (body.HasExceptionHandlers)
        {
            foreach (var handler in body.ExceptionHandlers)
            {
                ...
                trap.WriteTuple("il_exception_handler",
                    handlerId,
                    methodId,
