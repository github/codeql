...
| User-controlled data written to file (`js/http-to-file-access`) | security, external/cwe/cwe-434, external/cwe/cwe-912 | Highlights locations where user-controlled data is written to a file, possibly indicating a violation of [CWE-912](https://cwe.mitre.org/data/definitions/912.html). |
