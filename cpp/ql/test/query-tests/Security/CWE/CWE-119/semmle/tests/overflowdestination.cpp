...
void overflowdest_test1(FILE *f)
{
	...
	memcpy(dest, src, sizeof(src)); // BAD [NOT DETECTED by IR]: size derived from the source buffer
...
void overflowdest_test2(FILE *f, char *dest, char *src)
{
	...
	memcpy(dest, src, strlen(src) + 1); // BAD [NOT DETECTED by IR]: size derived from the source buffer
...
void overflowdest_test3(FILE *f, char *dest, char *src)
{
	...
	memcpy(dest2, src2, strlen(src2) + 1); // BAD [NOT DETECTED by IR]: size derived from the source buffer
