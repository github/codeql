...
int main(int argc, char **argv) {
	// BAD [NOT DETECTED]: i1 comes from the user
	char i1[1024];
	...
	// BAD [NOT DETECTED]: i3 comes from the user
	char i3[1024];
	fgets(i3, 1, 0);
	printf(i3);

	// BAD [NOT DETECTED]: i4 comes from the user
	char i41[1024];
	char *i4 = fgets(i41, 1, f);
	printf(i4);

	// BAD [NOT DETECTED]: i5 comes from the user
	char i5[1024];
	gets(i5);
	printf(i5);

	// BAD [NOT DETECTED]: i6 comes from the user
	char i61[1024];
	char *i6 = gets(i61);
	printf(i6);
