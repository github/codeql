...
struct CopyButNoAssign {
  CopyButNoAssign() : n(0) {}
  CopyButNoAssign(const CopyButNoAssign& copy_from) : n(copy_from.n) {} // $ Alert
  int n;
};

// NOT OK
struct AssignButNoCopy {
  AssignButNoCopy& operator=(const AssignButNoCopy& assign_from) { return *this; } // $ Alert
};
...
struct MyClassFriend {
  CopyableByFriend x;
  MyClassFriend& operator=(const MyClassFriend& that) { return *this; } // $ Alert
};
...
struct IsAProtectedAssign: public ProtectedAssign {
  IsAProtectedAssign(const IsAProtectedAssign& that) {} // $ Alert
};
...
struct IsAProtectedCC: public ProtectedCC {
  IsAProtectedCC& operator=(const IsAProtectedCC& that) { return *this; } // $ Alert
};
