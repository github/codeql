...
predicate reason(MacroInvocation mi, Element e, string reason) {
	(mi.getAnAffectedElement() = e and reason = "getAnAffectedElement()") or
	(mi.getAnExpandedElement() = e and reason = "getAnExpandedElement()") or
	(mi.getAGeneratedElement() = e and reason = "getAGeneratedElement()") or
	(mi.getExpr() = e and reason = "getExpr()") or
	(mi.getStmt() = e and reason = "getStmt()") or
	(mi.getEnclosingFunction() = e and reason = "getEnclosingFunction()")
}

string reasonspart(MacroInvocation mi, Element e) {
	reason(mi, e, result) or
