...
select fc, "Stack allocation is inside a $@ and could lead to stack overflow; consider hoisting the allocation out of the loop, or using 'malloc()' or 'new' instead.", l, l.toString()
