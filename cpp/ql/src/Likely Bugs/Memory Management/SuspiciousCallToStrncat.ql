 ...
 */
predicate interestringCallWithArgs(Call call, Expr sizeArg, VariableAccess destArg) {
...
predicate case1(FunctionCall fc, Expr sizeArg, VariableAccess destArg) {
  interestringCallWithArgs(pragma[only_bind_into](fc), pragma[only_bind_into](sizeArg),
    pragma[only_bind_into](destArg)) and
