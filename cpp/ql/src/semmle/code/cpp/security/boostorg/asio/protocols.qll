...
module BoostorgAsio {
    ...
    class SslContextMethod extends Enum {
        SslContextMethod() {
            this.getName().toString()= "method"
            and this.getQualifiedName().toString().matches("boost::asio::ssl::context%")
        }
        ...
        EnumConstant getABannedProtocolConstant() { 
            ...
            and (
                ...
                result.getName() = "sslv2" or

                /// SSL version 2 client.
                result.getName() = "sslv2_client" or

                /// SSL version 2 server.
                result.getName() = "sslv2_server" or
                
                /// Generic SSL version 3.
                result.getName() = "sslv3" or

                /// SSL version 3 client.
                result.getName() = "sslv3_client" or

                /// SSL version 3 server.
                result.getName() = "sslv3_server" or

                /// Generic TLS version 1.
                result.getName() = "tlsv1" or

                /// TLS version 1 client.
                result.getName() = "tlsv1_client" or

                /// TLS version 1 server.
                result.getName() = "tlsv1_server" or

                /// Generic TLS version 1.1.
                result.getName() = "tlsv11" or

                /// TLS version 1.1 client.
                result.getName() = "tlsv11_client" or
        ...
        EnumConstant getATls12ProtocolConstant() { 
            ...
            and (
                ...
                result.getName() = "tlsv12" or

                /// TLS version 1.2 client.
                result.getName() = "tlsv12_client" or
        ...
        EnumConstant getATls13ProtocolConstant() { 
            ...
            and (
                ...
                result.getName() = "tlsv13" or

                /// TLS version 1.3 client.
                result.getName() = "tlsv13_client" or
        ...
        EnumConstant getAGenericTlsProtocolConstant() { 
            ( 
                ...
                and (
                    /// Generic TLS
                    result.getName() = "tls" or

                    /// TLS client.
                    result.getName() = "tls_client" or
        ...
        EnumConstant getASslv23ProtocolConstant() { 
            ...
            and (
                ...
                /// Generic SSL/TLS.
                result.getName() = "sslv23" or

                /// SSL/TLS client.
                result.getName() = "sslv23_client" or
    ...
    class SslContextCallBannedProtocolConfig extends SslContextCallAbstractConfig {
        ...
        override predicate isSource(DataFlow::Node source) {
            exists( Expr e |
                ...
                e.fromSource() and
                not e.getLocation().getFile().toString().matches("%/boost/asio/%") 
                and isExprBannedBoostProtocol( e )
            )
        }
    }
    ...
    class SslContextCallTls12ProtocolConfig extends SslContextCallAbstractConfig {
        SslContextCallTls12ProtocolConfig() {
            this = "SslContextCallTls12ProtocolConfig"
        }
        ...
        override predicate isSource(DataFlow::Node source) {
            exists( Expr e |
                ...
                e.fromSource() and
                not e.getLocation().getFile().toString().matches("%/boost/asio/%") 
                and isExprTls12BoostProtocol( e )
            )
        }
    }
    ...
    class SslContextCallTls13ProtocolConfig extends SslContextCallAbstractConfig {
        ...
        override predicate isSource(DataFlow::Node source) {
            exists( Expr e |
                ...
                e.fromSource() and
                not e.getLocation().getFile().toString().matches("%/boost/asio/%") 
                and isExprTls13BoostProtocol( e )
            )
        }
    }
