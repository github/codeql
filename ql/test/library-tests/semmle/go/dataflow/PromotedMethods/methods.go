...
func (e *Embedded) sinkFieldOnEmbeddedPointerReceiver() {
	sink(e.field) // $MISSING:promotedmethods=nonPointerSender1 $MISSING:promotedmethods=pointerSender1 $MISSING:promotedmethods=nonPointerSender2 $MISSING:promotedmethods=pointerSender2
}
...
func (base1 *Base1) sinkFieldOnBase1PointerReceiver() {
	sink(base1.field) // $MISSING:promotedmethods=nonPointerSender1 $promotedmethods=pointerSender1
}
...
func (base2 *Base2) sinkFieldOnBase2PointerReceiver() {
	sink(base2.field) // $MISSING:promotedmethods=nonPointerSender2 $promotedmethods=pointerSender2
}
