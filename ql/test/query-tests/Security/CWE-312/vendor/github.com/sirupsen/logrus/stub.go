...
func (_ *Entry) Bytes() ([]uint8, interface {
	Error() string
}) {
	return nil, nil
}
...
func (_ *Entry) String() (string, interface {
	Error() string
}) {
	return "", nil
}
...
func (_ *Entry) WithError(_ interface {
	Error() string
}) *Entry {
	return nil
}
...
type Formatter interface {
	Format(_ *Entry) ([]uint8, interface {
		Error() string
	})
}

type Hook interface {
	Fire(_ *Entry) interface {
		Error() string
	}
	Levels() []Level
}
...
func (_ Level) MarshalText() ([]uint8, interface {
	Error() string
}) {
	return nil, nil
}
...
func (_ *Level) UnmarshalText(_ []uint8) interface {
	Error() string
} {
	return nil
}
...
func (_ LevelHooks) Fire(_ Level, _ *Entry) interface {
	Error() string
} {
	return nil
}
...
func (_ *Logger) WithError(_ interface {
	Error() string
}) *Entry {
	return nil
}
