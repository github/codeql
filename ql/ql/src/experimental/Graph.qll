/**
 * Defines how to emit graphs from CodeQL
 * 
 * Graphs are returned using the query predicates
...
{
    /**
     * Defines a graph in CodeQL, that the VSCode extension can render.
    ...
    */
    ...
    query predicate graph_chart(Graph graph, string key, float value)
    {
        graph.chartData(key, value)
    }
