...
// Source: github.com/labstack/echo/v4 (exports: Context; functions: )
...
type Echo struct {
	...
	OnAddRouteHandler func(string, Route, HandlerFunc, []MiddlewareFunc)
}
...
func (_ *Echo) FileFS(_ string, _ string, _ fs.FS, _ ...MiddlewareFunc) *Route {
	return nil
}
...
func (_ *Echo) ListenerAddr() net.Addr {
	return nil
}
...
func (_ *Echo) RouteNotFound(_ string, _ HandlerFunc, _ ...MiddlewareFunc) *Route {
	return nil
}
...
func (_ *Echo) StaticFS(_ string, _ fs.FS) *Route {
	return nil
}

func (_ *Echo) TLSListenerAddr() net.Addr {
	return nil
}
...
func (_ *Group) FileFS(_ string, _ string, _ fs.FS, _ ...MiddlewareFunc) *Route {
	return nil
}
...
func (_ *Group) RouteNotFound(_ string, _ HandlerFunc, _ ...MiddlewareFunc) *Route {
	return nil
}

func (_ *Group) Static(_ string, _ string) {}

func (_ *Group) StaticFS(_ string, _ fs.FS) {}
...
type JSONSerializer interface {
	Deserialize(_ Context, _ interface{}) error
	Serialize(_ Context, _ interface{}, _ string) error
}
...
func (_ *Response) Unwrap() http.ResponseWriter {
	return nil
}
...
func (_ *Router) Reverse(_ string, _ ...interface{}) string {
	return ""
}

func (_ *Router) Routes() []*Route {
	return nil
}
