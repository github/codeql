...
// This is a simple stub for github.com/beego/beego/v2/server/web/context, strictly for use in testing.

// See the LICENSE file for information about the licensing of the original library.
// Source: github.com/beego/beego/v2/server/web/context (exports: BeegoOutput,Context; functions: )

// Package context is a stub of github.com/beego/beego/v2/server/web/context, generated by depstubber.
package context
...
func (_ *BeegoInput) ParseFormOrMultiForm(_ int64) error {
	return nil
}
...
func (_ *BeegoOutput) Proto(_ interface{}) error {
	return nil
}

func (_ *BeegoOutput) Reset(_ *Context) {}

func (_ *BeegoOutput) ServeFormatted(_ interface{}, _ bool, _ ...bool) error {
	return nil
}
...
func (_ *Context) BindForm(_ interface{}) error {
	return nil
}
...
func (_ *Context) BindProtobuf(_ interface{}) error {
	return nil
}
...
func (_ *Context) JSONResp(_ interface{}) error {
	return nil
}

func (_ *Context) ProtoResp(_ interface{}) error {
	return nil
}
...
func (_ *Context) Resp(_ interface{}) error {
	return nil
}

func (_ *Context) Session() (interface{}, error) {
	return nil, nil
}
...
func (_ *Context) XMLResp(_ interface{}) error {
	return nil
}
...
func (_ *Context) YamlResp(_ interface{}) error {
	return nil
}
