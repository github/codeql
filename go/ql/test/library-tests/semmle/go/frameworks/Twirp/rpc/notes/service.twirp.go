...
func NewNotesServiceProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) NotesService { // test: clientConstructor
	...
	serviceURL += baseServicePath(pathPrefix, "gotwirprpcexample.rpc.notes", "NotesService")
	urls := [2]string{
...
const NotesServicePathPrefix = "/twirp/gotwirprpcexample.rpc.notes.NotesService/"
...
func (s *notesServiceServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	if pkgService != "gotwirprpcexample.rpc.notes.NotesService" {
...
func (s *notesServiceServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "gotwirprpcexample.rpc.notes", "NotesService")
}
