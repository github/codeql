...
func TaintStepTest_StringsFieldsFuncSeq(sourceCQL interface{}) interface{} {
	for result := range strings.FieldsFuncSeq(sourceCQL.(string), nil) {
		return result
	}
	return ""
}

func TaintStepTest_StringsFieldsSeq(sourceCQL interface{}) interface{} {
	for result := range strings.FieldsSeq(sourceCQL.(string)) {
		return result
	}
	return ""
}

func TaintStepTest_StringsLines(sourceCQL interface{}) interface{} {
	for result := range strings.Lines(sourceCQL.(string)) {
		return result
	}
	return ""
}

func TaintStepTest_StringsSplitAfterSeq(sourceCQL interface{}) interface{} {
	for result := range strings.SplitAfterSeq(sourceCQL.(string), "") {
		return result
	}
	return ""
}

func TaintStepTest_StringsSplitSeq(sourceCQL interface{}) interface{} {
	for result := range strings.SplitSeq(sourceCQL.(string), "") {
		return result
	}
	return ""
}
...
func RunAllTaints_Strings() {
	...
	// {
	// 	source := newSource(50)
	// 	out := TaintStepTest_StringsFieldsFuncSeq(source)
	// 	sink(50, out)
	// }
	// {
	// 	source := newSource(51)
	// 	out := TaintStepTest_StringsFieldsSeq(source)
	// 	sink(51, out)
	// }
	// {
	// 	source := newSource(52)
	// 	out := TaintStepTest_StringsLines(source)
	// 	sink(52, out)
	// }
	// {
	// 	source := newSource(53)
	// 	out := TaintStepTest_StringsSplitAfterSeq(source)
	// 	sink(53, out)
	// }
	// {
	// 	source := newSource(54)
	// 	out := TaintStepTest_StringsSplitSeq(source)
	// 	sink(54, out)
	// }
	{
		source := newSource(55)
