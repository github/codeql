...
// Source: github.com/valyala/fasthttp (exports: RequestHeader,URI,Args,TCPDialer,Client,Request,Response,RequestCtx; functions: DoRedirects,ServeFile,ServeFileBytesUncompressed,ServeFileUncompressed,ServeFileBytes,SaveMultipartFile,DoRedirects,AppendHTMLEscape,AppendHTMLEscapeBytes,AppendQuotedArg,DialDualStack,Dial,DialTimeout,DialDualStackTimeout,Get,GetDeadline,GetTimeout,Post,Do,DoDeadline,DoTimeout)
