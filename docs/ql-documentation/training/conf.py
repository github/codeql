# -*- coding: utf-8 -*-
#
# QL training material build configuration file, created 
...
# Modified 22052019.
#
# The configuration values below are specific to the QL training pages
