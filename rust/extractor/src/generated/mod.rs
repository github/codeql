...
#[derive(Debug)]
pub struct CanonicalPathElement {
    _unused: ()
}

impl trap::TrapClass for CanonicalPathElement {
    fn class_name() -> &'static str { "CanonicalPathElement" }
}

impl From<trap::Label<CanonicalPathElement>> for trap::Label<Element> {
    fn from(value: trap::Label<CanonicalPathElement>) -> Self {
        // SAFETY: this is safe because in the dbscheme CanonicalPathElement is a subclass of Element
        unsafe {
            Self::from_untyped(value.as_untyped())
        }
    }
...
impl trap::TrapClass for CanonicalPath {
    fn class_name() -> &'static str { "CanonicalPath" }
}

impl From<trap::Label<CanonicalPath>> for trap::Label<CanonicalPathElement> {
    fn from(value: trap::Label<CanonicalPath>) -> Self {
        // SAFETY: this is safe because in the dbscheme CanonicalPath is a subclass of CanonicalPathElement
        unsafe {
            Self::from_untyped(value.as_untyped())
        }
    }
...
impl From<trap::Label<CanonicalPath>> for trap::Label<Element> {
    fn from(value: trap::Label<CanonicalPath>) -> Self {
        // SAFETY: this is safe because in the dbscheme CanonicalPath is a subclass of Element
        unsafe {
            Self::from_untyped(value.as_untyped())
        }
    }
...
impl trap::TrapClass for TypeGenericArg {
    fn class_name() -> &'static str { "TypeGenericArg" }
}

impl From<trap::Label<TypeGenericArg>> for trap::Label<CanonicalPathElement> {
    fn from(value: trap::Label<TypeGenericArg>) -> Self {
        // SAFETY: this is safe because in the dbscheme TypeGenericArg is a subclass of CanonicalPathElement
        unsafe {
            Self::from_untyped(value.as_untyped())
        }
    }
...
impl From<trap::Label<TypeGenericArg>> for trap::Label<Element> {
    fn from(value: trap::Label<TypeGenericArg>) -> Self {
        // SAFETY: this is safe because in the dbscheme TypeGenericArg is a subclass of Element
        unsafe {
            Self::from_untyped(value.as_untyped())
        }
    }
...
#[derive(Debug)]
pub struct ConstGenericTypeArg {
    pub id: trap::TrapId<ConstGenericTypeArg>,
    pub value: String,
}

impl trap::TrapEntry for ConstGenericTypeArg {
    fn extract_id(&mut self) -> trap::TrapId<Self> {
        std::mem::replace(&mut self.id, trap::TrapId::Star)
    }

    fn emit(self, id: trap::Label<Self>, out: &mut trap::Writer) {
        out.add_tuple("const_generic_type_args", vec![id.into(), self.value.into()]);
    }
}

impl trap::TrapClass for ConstGenericTypeArg {
    fn class_name() -> &'static str { "ConstGenericTypeArg" }
}

impl From<trap::Label<ConstGenericTypeArg>> for trap::Label<CanonicalPathElement> {
    fn from(value: trap::Label<ConstGenericTypeArg>) -> Self {
        // SAFETY: this is safe because in the dbscheme ConstGenericTypeArg is a subclass of CanonicalPathElement
        unsafe {
            Self::from_untyped(value.as_untyped())
        }
    }
...
impl From<trap::Label<ConstGenericTypeArg>> for trap::Label<Element> {
    fn from(value: trap::Label<ConstGenericTypeArg>) -> Self {
        // SAFETY: this is safe because in the dbscheme ConstGenericTypeArg is a subclass of Element
        unsafe {
            Self::from_untyped(value.as_untyped())
        }
    }
...
impl From<trap::Label<ConstGenericTypeArg>> for trap::Label<TypeGenericArg> {
    fn from(value: trap::Label<ConstGenericTypeArg>) -> Self {
        // SAFETY: this is safe because in the dbscheme ConstGenericTypeArg is a subclass of TypeGenericArg
        unsafe {
            Self::from_untyped(value.as_untyped())
        }
    }
...
#[derive(Debug)]
pub struct ModuleItemCanonicalPath {
    pub id: trap::TrapId<ModuleItemCanonicalPath>,
    pub namespace: trap::Label<Namespace>,
    pub name: String,
}

impl trap::TrapEntry for ModuleItemCanonicalPath {
    fn extract_id(&mut self) -> trap::TrapId<Self> {
        std::mem::replace(&mut self.id, trap::TrapId::Star)
    }

    fn emit(self, id: trap::Label<Self>, out: &mut trap::Writer) {
        out.add_tuple("module_item_canonical_paths", vec![id.into(), self.namespace.into(), self.name.into()]);
    }
}

impl trap::TrapClass for ModuleItemCanonicalPath {
    fn class_name() -> &'static str { "ModuleItemCanonicalPath" }
}

impl From<trap::Label<ModuleItemCanonicalPath>> for trap::Label<CanonicalPath> {
    fn from(value: trap::Label<ModuleItemCanonicalPath>) -> Self {
        // SAFETY: this is safe because in the dbscheme ModuleItemCanonicalPath is a subclass of CanonicalPath
        unsafe {
            Self::from_untyped(value.as_untyped())
        }
    }
...
impl From<trap::Label<ModuleItemCanonicalPath>> for trap::Label<CanonicalPathElement> {
    fn from(value: trap::Label<ModuleItemCanonicalPath>) -> Self {
        // SAFETY: this is safe because in the dbscheme ModuleItemCanonicalPath is a subclass of CanonicalPathElement
        unsafe {
            Self::from_untyped(value.as_untyped())
        }
    }
...
impl From<trap::Label<ModuleItemCanonicalPath>> for trap::Label<Element> {
    fn from(value: trap::Label<ModuleItemCanonicalPath>) -> Self {
        // SAFETY: this is safe because in the dbscheme ModuleItemCanonicalPath is a subclass of Element
        unsafe {
            Self::from_untyped(value.as_untyped())
        }
    }
...
impl trap::TrapEntry for Namespace {
    fn extract_id(&mut self) -> trap::TrapId<Self> {
        std::mem::replace(&mut self.id, trap::TrapId::Star)
    }

    fn emit(self, id: trap::Label<Self>, out: &mut trap::Writer) {
        out.add_tuple("namespaces", vec![id.into(), self.root.into(), self.path.into()]);
    }
}

impl trap::TrapClass for Namespace {
    fn class_name() -> &'static str { "Namespace" }
}

impl From<trap::Label<Namespace>> for trap::Label<CanonicalPath> {
    fn from(value: trap::Label<Namespace>) -> Self {
        // SAFETY: this is safe because in the dbscheme Namespace is a subclass of CanonicalPath
        unsafe {
            Self::from_untyped(value.as_untyped())
        }
    }
...
impl From<trap::Label<Namespace>> for trap::Label<CanonicalPathElement> {
    fn from(value: trap::Label<Namespace>) -> Self {
        // SAFETY: this is safe because in the dbscheme Namespace is a subclass of CanonicalPathElement
        unsafe {
            Self::from_untyped(value.as_untyped())
        }
    }
...
impl From<trap::Label<Namespace>> for trap::Label<Element> {
    fn from(value: trap::Label<Namespace>) -> Self {
        // SAFETY: this is safe because in the dbscheme Namespace is a subclass of Element
        unsafe {
            Self::from_untyped(value.as_untyped())
        }
    }
...
#[derive(Debug)]
pub struct ParametrizedCanonicalPath {
    pub id: trap::TrapId<ParametrizedCanonicalPath>,
    pub base: trap::Label<ModuleItemCanonicalPath>,
    pub generic_args: Vec<trap::Label<TypeGenericArg>>,
}

impl trap::TrapEntry for ParametrizedCanonicalPath {
    fn extract_id(&mut self) -> trap::TrapId<Self> {
        std::mem::replace(&mut self.id, trap::TrapId::Star)
    }

    fn emit(self, id: trap::Label<Self>, out: &mut trap::Writer) {
        out.add_tuple("parametrized_canonical_paths", vec![id.into(), self.base.into()]);
        for (i, v) in self.generic_args.into_iter().enumerate() {
            out.add_tuple("parametrized_canonical_path_generic_args", vec![id.into(), i.into(), v.into()]);
        }
    }
}

impl trap::TrapClass for ParametrizedCanonicalPath {
    fn class_name() -> &'static str { "ParametrizedCanonicalPath" }
}

impl From<trap::Label<ParametrizedCanonicalPath>> for trap::Label<CanonicalPath> {
    fn from(value: trap::Label<ParametrizedCanonicalPath>) -> Self {
        // SAFETY: this is safe because in the dbscheme ParametrizedCanonicalPath is a subclass of CanonicalPath
        unsafe {
            Self::from_untyped(value.as_untyped())
        }
    }
...
impl From<trap::Label<ParametrizedCanonicalPath>> for trap::Label<CanonicalPathElement> {
    fn from(value: trap::Label<ParametrizedCanonicalPath>) -> Self {
        // SAFETY: this is safe because in the dbscheme ParametrizedCanonicalPath is a subclass of CanonicalPathElement
        unsafe {
            Self::from_untyped(value.as_untyped())
        }
    }
...
impl From<trap::Label<ParametrizedCanonicalPath>> for trap::Label<Element> {
    fn from(value: trap::Label<ParametrizedCanonicalPath>) -> Self {
        // SAFETY: this is safe because in the dbscheme ParametrizedCanonicalPath is a subclass of Element
        unsafe {
            Self::from_untyped(value.as_untyped())
        }
    }
...
impl trap::TrapClass for TypeCanonicalPath {
    fn class_name() -> &'static str { "TypeCanonicalPath" }
}

impl From<trap::Label<TypeCanonicalPath>> for trap::Label<CanonicalPath> {
    fn from(value: trap::Label<TypeCanonicalPath>) -> Self {
        // SAFETY: this is safe because in the dbscheme TypeCanonicalPath is a subclass of CanonicalPath
        unsafe {
            Self::from_untyped(value.as_untyped())
        }
    }
...
impl From<trap::Label<TypeCanonicalPath>> for trap::Label<CanonicalPathElement> {
    fn from(value: trap::Label<TypeCanonicalPath>) -> Self {
        // SAFETY: this is safe because in the dbscheme TypeCanonicalPath is a subclass of CanonicalPathElement
        unsafe {
            Self::from_untyped(value.as_untyped())
        }
    }
...
impl From<trap::Label<TypeCanonicalPath>> for trap::Label<Element> {
    fn from(value: trap::Label<TypeCanonicalPath>) -> Self {
        // SAFETY: this is safe because in the dbscheme TypeCanonicalPath is a subclass of Element
        unsafe {
            Self::from_untyped(value.as_untyped())
        }
    }
...
#[derive(Debug)]
pub struct TypeGenericTypeArg {
    pub id: trap::TrapId<TypeGenericTypeArg>,
    pub path: trap::Label<TypeCanonicalPath>,
}

impl trap::TrapEntry for TypeGenericTypeArg {
    fn extract_id(&mut self) -> trap::TrapId<Self> {
        std::mem::replace(&mut self.id, trap::TrapId::Star)
    }

    fn emit(self, id: trap::Label<Self>, out: &mut trap::Writer) {
        out.add_tuple("type_generic_type_args", vec![id.into(), self.path.into()]);
    }
}

impl trap::TrapClass for TypeGenericTypeArg {
    fn class_name() -> &'static str { "TypeGenericTypeArg" }
}

impl From<trap::Label<TypeGenericTypeArg>> for trap::Label<CanonicalPathElement> {
    fn from(value: trap::Label<TypeGenericTypeArg>) -> Self {
        // SAFETY: this is safe because in the dbscheme TypeGenericTypeArg is a subclass of CanonicalPathElement
        unsafe {
            Self::from_untyped(value.as_untyped())
        }
    }
...
impl From<trap::Label<TypeGenericTypeArg>> for trap::Label<Element> {
    fn from(value: trap::Label<TypeGenericTypeArg>) -> Self {
        // SAFETY: this is safe because in the dbscheme TypeGenericTypeArg is a subclass of Element
        unsafe {
            Self::from_untyped(value.as_untyped())
        }
    }
...
impl trap::TrapEntry for TypeItemCanonicalPath {
    fn extract_id(&mut self) -> trap::TrapId<Self> {
        std::mem::replace(&mut self.id, trap::TrapId::Star)
    }

    fn emit(self, id: trap::Label<Self>, out: &mut trap::Writer) {
        out.add_tuple("type_item_canonical_paths", vec![id.into(), self.parent.into(), self.name.into()]);
    }
}

impl trap::TrapClass for TypeItemCanonicalPath {
    fn class_name() -> &'static str { "TypeItemCanonicalPath" }
}

impl From<trap::Label<TypeItemCanonicalPath>> for trap::Label<CanonicalPath> {
    fn from(value: trap::Label<TypeItemCanonicalPath>) -> Self {
        // SAFETY: this is safe because in the dbscheme TypeItemCanonicalPath is a subclass of CanonicalPath
        unsafe {
            Self::from_untyped(value.as_untyped())
        }
    }
...
impl From<trap::Label<TypeItemCanonicalPath>> for trap::Label<CanonicalPathElement> {
    fn from(value: trap::Label<TypeItemCanonicalPath>) -> Self {
        // SAFETY: this is safe because in the dbscheme TypeItemCanonicalPath is a subclass of CanonicalPathElement
        unsafe {
            Self::from_untyped(value.as_untyped())
        }
    }
...
impl From<trap::Label<TypeItemCanonicalPath>> for trap::Label<Element> {
    fn from(value: trap::Label<TypeItemCanonicalPath>) -> Self {
        // SAFETY: this is safe because in the dbscheme TypeItemCanonicalPath is a subclass of Element
        unsafe {
            Self::from_untyped(value.as_untyped())
        }
    }
...
#[derive(Debug)]
pub struct BuiltinTypeCanonicalPath {
    pub id: trap::TrapId<BuiltinTypeCanonicalPath>,
    pub name: String,
}

impl trap::TrapEntry for BuiltinTypeCanonicalPath {
    fn extract_id(&mut self) -> trap::TrapId<Self> {
        std::mem::replace(&mut self.id, trap::TrapId::Star)
    }

    fn emit(self, id: trap::Label<Self>, out: &mut trap::Writer) {
        out.add_tuple("builtin_type_canonical_paths", vec![id.into(), self.name.into()]);
    }
}

impl trap::TrapClass for BuiltinTypeCanonicalPath {
    fn class_name() -> &'static str { "BuiltinTypeCanonicalPath" }
}

impl From<trap::Label<BuiltinTypeCanonicalPath>> for trap::Label<CanonicalPath> {
    fn from(value: trap::Label<BuiltinTypeCanonicalPath>) -> Self {
        // SAFETY: this is safe because in the dbscheme BuiltinTypeCanonicalPath is a subclass of CanonicalPath
        unsafe {
            Self::from_untyped(value.as_untyped())
        }
    }
...
impl From<trap::Label<BuiltinTypeCanonicalPath>> for trap::Label<CanonicalPathElement> {
    fn from(value: trap::Label<BuiltinTypeCanonicalPath>) -> Self {
        // SAFETY: this is safe because in the dbscheme BuiltinTypeCanonicalPath is a subclass of CanonicalPathElement
        unsafe {
            Self::from_untyped(value.as_untyped())
        }
    }
...
impl From<trap::Label<BuiltinTypeCanonicalPath>> for trap::Label<Element> {
    fn from(value: trap::Label<BuiltinTypeCanonicalPath>) -> Self {
        // SAFETY: this is safe because in the dbscheme BuiltinTypeCanonicalPath is a subclass of Element
        unsafe {
            Self::from_untyped(value.as_untyped())
        }
    }
...
impl From<trap::Label<BuiltinTypeCanonicalPath>> for trap::Label<TypeCanonicalPath> {
    fn from(value: trap::Label<BuiltinTypeCanonicalPath>) -> Self {
        // SAFETY: this is safe because in the dbscheme BuiltinTypeCanonicalPath is a subclass of TypeCanonicalPath
        unsafe {
            Self::from_untyped(value.as_untyped())
        }
    }
...
#[derive(Debug)]
pub struct ConcreteTypeCanonicalPath {
    pub id: trap::TrapId<ConcreteTypeCanonicalPath>,
    pub path: trap::Label<ParametrizedCanonicalPath>,
}

impl trap::TrapEntry for ConcreteTypeCanonicalPath {
    fn extract_id(&mut self) -> trap::TrapId<Self> {
        std::mem::replace(&mut self.id, trap::TrapId::Star)
    }

    fn emit(self, id: trap::Label<Self>, out: &mut trap::Writer) {
        out.add_tuple("concrete_type_canonical_paths", vec![id.into(), self.path.into()]);
    }
}

impl trap::TrapClass for ConcreteTypeCanonicalPath {
    fn class_name() -> &'static str { "ConcreteTypeCanonicalPath" }
}

impl From<trap::Label<ConcreteTypeCanonicalPath>> for trap::Label<CanonicalPath> {
    fn from(value: trap::Label<ConcreteTypeCanonicalPath>) -> Self {
        // SAFETY: this is safe because in the dbscheme ConcreteTypeCanonicalPath is a subclass of CanonicalPath
        unsafe {
            Self::from_untyped(value.as_untyped())
        }
    }
...
impl From<trap::Label<ConcreteTypeCanonicalPath>> for trap::Label<CanonicalPathElement> {
    fn from(value: trap::Label<ConcreteTypeCanonicalPath>) -> Self {
        // SAFETY: this is safe because in the dbscheme ConcreteTypeCanonicalPath is a subclass of CanonicalPathElement
        unsafe {
            Self::from_untyped(value.as_untyped())
        }
    }
...
impl From<trap::Label<ConcreteTypeCanonicalPath>> for trap::Label<Element> {
    fn from(value: trap::Label<ConcreteTypeCanonicalPath>) -> Self {
        // SAFETY: this is safe because in the dbscheme ConcreteTypeCanonicalPath is a subclass of Element
        unsafe {
            Self::from_untyped(value.as_untyped())
        }
    }
...
impl From<trap::Label<ConcreteTypeCanonicalPath>> for trap::Label<TypeCanonicalPath> {
    fn from(value: trap::Label<ConcreteTypeCanonicalPath>) -> Self {
        // SAFETY: this is safe because in the dbscheme ConcreteTypeCanonicalPath is a subclass of TypeCanonicalPath
        unsafe {
            Self::from_untyped(value.as_untyped())
        }
    }
...
impl trap::TrapEntry for DerivedTypeCanonicalPath {
    fn extract_id(&mut self) -> trap::TrapId<Self> {
        std::mem::replace(&mut self.id, trap::TrapId::Star)
    }
...
impl trap::TrapClass for DerivedTypeCanonicalPath {
    fn class_name() -> &'static str { "DerivedTypeCanonicalPath" }
}

impl From<trap::Label<DerivedTypeCanonicalPath>> for trap::Label<CanonicalPath> {
    fn from(value: trap::Label<DerivedTypeCanonicalPath>) -> Self {
        // SAFETY: this is safe because in the dbscheme DerivedTypeCanonicalPath is a subclass of CanonicalPath
        unsafe {
            Self::from_untyped(value.as_untyped())
        }
    }
...
impl From<trap::Label<DerivedTypeCanonicalPath>> for trap::Label<CanonicalPathElement> {
    fn from(value: trap::Label<DerivedTypeCanonicalPath>) -> Self {
        // SAFETY: this is safe because in the dbscheme DerivedTypeCanonicalPath is a subclass of CanonicalPathElement
        unsafe {
            Self::from_untyped(value.as_untyped())
        }
    }
...
impl From<trap::Label<DerivedTypeCanonicalPath>> for trap::Label<Element> {
    fn from(value: trap::Label<DerivedTypeCanonicalPath>) -> Self {
        // SAFETY: this is safe because in the dbscheme DerivedTypeCanonicalPath is a subclass of Element
        unsafe {
            Self::from_untyped(value.as_untyped())
        }
    }
...
impl From<trap::Label<DerivedTypeCanonicalPath>> for trap::Label<TypeCanonicalPath> {
    fn from(value: trap::Label<DerivedTypeCanonicalPath>) -> Self {
        // SAFETY: this is safe because in the dbscheme DerivedTypeCanonicalPath is a subclass of TypeCanonicalPath
        unsafe {
            Self::from_untyped(value.as_untyped())
        }
    }
...
#[derive(Debug)]
pub struct PlaceholderTypeCanonicalPath {
    pub id: trap::TrapId<PlaceholderTypeCanonicalPath>,
}

impl trap::TrapEntry for PlaceholderTypeCanonicalPath {
    fn extract_id(&mut self) -> trap::TrapId<Self> {
        std::mem::replace(&mut self.id, trap::TrapId::Star)
    }

    fn emit(self, id: trap::Label<Self>, out: &mut trap::Writer) {
        out.add_tuple("placeholder_type_canonical_paths", vec![id.into()]);
    }
}

impl trap::TrapClass for PlaceholderTypeCanonicalPath {
    fn class_name() -> &'static str { "PlaceholderTypeCanonicalPath" }
}

impl From<trap::Label<PlaceholderTypeCanonicalPath>> for trap::Label<CanonicalPath> {
    fn from(value: trap::Label<PlaceholderTypeCanonicalPath>) -> Self {
        // SAFETY: this is safe because in the dbscheme PlaceholderTypeCanonicalPath is a subclass of CanonicalPath
        unsafe {
            Self::from_untyped(value.as_untyped())
        }
    }
...
impl From<trap::Label<PlaceholderTypeCanonicalPath>> for trap::Label<CanonicalPathElement> {
    fn from(value: trap::Label<PlaceholderTypeCanonicalPath>) -> Self {
        // SAFETY: this is safe because in the dbscheme PlaceholderTypeCanonicalPath is a subclass of CanonicalPathElement
        unsafe {
            Self::from_untyped(value.as_untyped())
        }
    }
...
impl From<trap::Label<PlaceholderTypeCanonicalPath>> for trap::Label<Element> {
    fn from(value: trap::Label<PlaceholderTypeCanonicalPath>) -> Self {
        // SAFETY: this is safe because in the dbscheme PlaceholderTypeCanonicalPath is a subclass of Element
        unsafe {
            Self::from_untyped(value.as_untyped())
        }
    }
...
impl From<trap::Label<PlaceholderTypeCanonicalPath>> for trap::Label<TypeCanonicalPath> {
    fn from(value: trap::Label<PlaceholderTypeCanonicalPath>) -> Self {
        // SAFETY: this is safe because in the dbscheme PlaceholderTypeCanonicalPath is a subclass of TypeCanonicalPath
        unsafe {
            Self::from_untyped(value.as_untyped())
        }
    }
