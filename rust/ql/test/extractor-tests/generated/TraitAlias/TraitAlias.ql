...
from
  TraitAlias x, int getNumberOfAttrs, string hasGenericParamList, string hasName,
...
select x, "getNumberOfAttrs:", getNumberOfAttrs, "hasGenericParamList:", hasGenericParamList,
  "hasName:", hasName, "hasTypeBoundList:", hasTypeBoundList, "hasVisibility:", hasVisibility,
