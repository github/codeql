...
from
  ClosureExpr x, string hasParamList, int getNumberOfAttrs, string hasType, string hasBody,
...
select x, "hasParamList:", hasParamList, "getNumberOfAttrs:", getNumberOfAttrs, "hasType:", hasType,
  "hasBody:", hasBody, "hasClosureBinder:", hasClosureBinder, "isAsync:", isAsync, "isConst:",
  isConst, "isGen:", isGen, "isMove:", isMove, "isStatic:", isStatic, "hasRetType:", hasRetType
