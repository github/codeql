...
mod function_trait_bounds {
    ...
    fn call_trait_m1_2<T1, T2: MyTrait<T1>>(x: T2) -> T1 {
        T2::m1(x) // $ target=m1 $ MISSING: type=x.m1():T1
    }
    ...
    pub fn f() {
        ...
        println!("{:?}", call_trait_m1_2(x2)); // $ target=call_trait_m1_2
        println!("{:?}", call_trait_m1(y2)); // $ target=call_trait_m1
        println!("{:?}", call_trait_m1_2(y2)); // $ target=call_trait_m1_2
