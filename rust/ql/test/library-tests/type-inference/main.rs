...
mod method_non_parametric_trait_impl {
    ...
    fn type_bound_type_parameter_impl<TP: MyTrait<S1>>(thing: TP) -> S1 {
        ...
        thing.convert_to() // $ target=T::convert_to SPURIOUS: target=ConvertTo::convert_to
    }
    ...
    pub fn f() {
        ...
        let i = thing.convert_to(); // $ type=i:S1 target=T::convert_to target=ConvertTo::convert_to
